...
//for act and rules .....
var is_act_and_rules_loaded = false;
...
var is_terms_and_conditions = false;
...
var notice_page_number = 1;
function loadMoreNotice() {
  var load_btn = document.getElementById("notice_load_btn");
  load_btn.disabled = true;
  var button_text = load_btn.innerText;
  var loading_sign = '...<i class="fa fa-spinner fa-spin"></i>';
  var has_available_notice = true;
  $.ajax({
...
function lazyLoadSliderImage() {
  ...
  for (var _i = 0; _i < imgDefer.length; _i++) {
    if (imgDefer[_i].getAttribute('data-src')) {
      imgDefer[_i].setAttribute('src', imgDefer[_i].getAttribute('data-src'));
    }
  }
}
