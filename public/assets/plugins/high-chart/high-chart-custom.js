...
(function (U, M) {
    ...
    M(a, "Core/Utilities.js", [a["Core/Globals.js"]], function (a) {
        function x(c, b, f, k) {
            ...
            d(a, "displayError", {chart: f, code: c, message: e, params: k}, function () {
                if (b) throw Error(e);
        ...
        E({map: "map", each: "forEach", grep: "filter", reduce: "reduce", some: "some"}, function (c, b) {
            a[b] = function (f) {
        ...
        G = {
            addEvent: function (c, b, f, d = {}) {
                ...
                n[b] || (n[b] = []);
                n[b].push({fn: f, order: "number" === typeof d.order ? d.order : Infinity});
            ...
            insertItem: function (b, f) {
                const c = b.options.index, d = f.length;
                let n;
    ...
    M(a, "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y) {
        const {win: x} = a, {
                ...
                splat: p,
                timeUnits: t
            } = y, m = a.isSafari && x.Intl && x.Intl.DateTimeFormat.prototype.formatRange,
        ...
        class g {
            ...
            get(e, g) {
                if (this.variableTimezone || this.timezoneOffset) {
                    const h = g.getTime(), m = h - this.getTimezoneOffset(g);
                    g.setTime(m);
                    e = g["getUTC" + e]();
                    g.setTime(h);
                    return e
            ...
            timezoneOffsetFunction() {
                const e = this, g = this.options, h = g.getTimezoneOffset, m = g.moment || x.moment;
            ...
            dateFormat(e, g, h) {
                ...
                const k = this.get("Hours", d), r = this.get("Day", d), q = this.get("Date", d),
                    w = this.get("Month", d), b = this.get("FullYear", d), f = a.defaultOptions.lang,
                    c = f && f.weekdays, n = f && f.shortWeekdays;
                d = z({
                    a: n ? n[r] :
                        c[r].substr(0, 3),
                    A: c[r],
            ...
            getTimeTicks(e, g, h, m) {
                ...
                if (L(g)) {
                    ...
                    c = d.get("FullYear", q);
                    m = d.get("Month", q);
                    const n = d.get("Date", q), e = d.get("Hours", q);
                    g = q.getTime();
    ...
    M(a, "Core/Defaults.js", [a["Core/Chart/ChartDefaults.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Color/Palettes.js"], a["Core/Time.js"], a["Core/Utilities.js"]], function (a, y, I, L, C, z) {
        ...
        a = {
            defaultOptions: v, defaultTime: l, getOptions: function () {
                return v
    ...
    M(a, "Core/Animation/Fx.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y, I) {
        const {parse: x} = a, {win: C} = y, {isNumber: z, objectEach: H} = I;
        ...
        class B {
            ...
            dSetter() {
                ...
                const l = this.now || 0;
                let p = [];
                if (1 !== l && v && a) if (v.length === a.length && 1 > l) for (let t = 0; t < a.length; t++) {
                    const m = v[t], h = a[t], g = [];
                    ...
                    p.push(g)
                } else p = a; else p = this.toD || [];
                this.elem.attr("d", p, void 0, !0)
            }

            update() {
                const a = this.elem, v = this.prop, l = this.now, p = this.options.step;
                if (this[v + "Setter"]) this[v + "Setter"](); else a.attr ?
            ...
            step(a) {
                const v = +new Date, l = this.options, p = this.elem, t = l.complete, m = l.duration, h = l.curAnim;
                let g;
            ...
            initPath(a,
                ...
                const m = a.startX, h = a.endX;
                l = l.slice();
                const g = a.isArea, e = g ? 2 : 1;
                let w, E, F;
                v = v && v.slice();
                if (!v) return [l,
                    l];
    ...
    M(a, "Core/Animation/AnimationUtilities.js",
        [a["Core/Animation/Fx.js"], a["Core/Utilities.js"]], function (a, y) {
            function x(a) {
                return u(a) ? v({duration: 500, defer: 0}, a) : {duration: a ? 500 : 0, defer: 0}
            }
    ...
    M(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y) {
        ...
        ({trustedTypes: y} = L);
        const t =
            y && u(y.createPolicy) && y.createPolicy("highcharts", {createHTML: e => e});
        y = t ? t.createHTML("") : "";
        try {
        ...
        class g {
            static filterUserAttributes(e) {
                l(e, (h, m) => {
                    ...
                    a || (B(33, !1, void 0, {"Invalid attribute in config": `${m}`}), delete e[m]);
            ...
            addToDOM(e) {
                function h(e, m) {
                    ...
                    p(e).forEach(function (k) {
                        var e = k.tagName;
                        const q = k.textContent ? a.doc.createTextNode(k.textContent) : void 0, w =
    ...
    M(a, "Core/Templating.js", [a["Core/Defaults.js"], a["Core/Utilities.js"]], function (a, y) {
        function x(h = "", g, e) {
            const a = /\{([a-zA-Z0-9:\.,;\-\/<>%_@"'= #\(\)]+)\}/g, l = /\(([a-zA-Z0-9:\.,;\-\/<>%_@"'= ]+)\)/g, v = [],
                d = /f$/, k = /\.([0-9])/, r = C.lang, q = e && e.time || z, G = e && e.numberFormatter || L,
                b = (b = "") => {
                    let c;
            ...
            for (; null !== (f = a.exec(h));) {
                ...
                D = "else" === f[1];
                if (c.isBlock && c.fn && (f[1] === `/${c.fn}` || D)) if (n) D || n--; else {
                    var K = c.startInner;
        ...
        const {defaultOptions: C, defaultTime: z} = a, {
            ...
            each: function (h) {
                ...
                return u(h) ? h.map((e, a) => x(g.body, H(l(e) ? e : {"@this": e}, {
                        "@index": a,
                        "@first": 0 === a,
                        "@last": a === h.length - 1
                    }))).join("") :
    ...
    M(a, "Core/Renderer/RendererUtilities.js", [a["Core/Utilities.js"]], function (a) {
        ...
        (function (a) {
            function y(a, u, v) {
                const l = a;
                var p = l.reducedLen || u, t = (e, g) => (g.rank || 0) - (e.rank || 0);
                ...
                L(a, m);
                for (a = a.map(e => ({size: e.size, targets: [e.target], align: I(e.align, .5)})); g;) {
    ...
    M(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"],
        ...
        class D {
            ...
            add(b) {
                const c = this.renderer, f = this.element;
                let d;
            ...
            align(b, c, d) {
                const k = {};
                var n = this.renderer, e = n.alignedObjects, A;
                let K, g;
                if (b) {
            ...
            animate(c,
                ...
                0 !== e.duration ? (k && (e.complete = k), n(() => {
                    ...
                    e.step && e.step.call(this, b, {prop: c, pos: 1, elem: this})
                }, this));
                return this
            }
            ...
            attr(c, f, d, k) {
                const n = this.element, e = D.symbolCustomAttribs;
                let A, q, g = this, a, K;
            ...
            complexColor(c, f, k) {
                ...
                F(this.renderer, "complexColor", {args: arguments}, function () {
                    ...
                    if (g) {
                        ...
                        K = c.stops;
                        m = k.radialReference;
                        d(A) && (c[g] = A = {x1: A[0], y1: A[1], x2: A[2], y2: A[3], gradientUnits: "userSpaceOnUse"});
                        "radialGradient" === g && m && !e(A.gradientUnits) && (a = A, A = G(A, n.getRadialAttr(m, a), {gradientUnits: "userSpaceOnUse"}));
                        b(A, function (b, c) {
                            "id" !==
                            c && w.push(c, b)
                        });
            ...
            getBBox(b, c) {
                const {alignValue: d, element: n, renderer: q, styles: a, textStr: A} = this, {
                    cache: r,
                    cacheKeys: h
                } = q;
                ...
                if (!J) {
                    ...
                    O = J.width;
                    b = J.height;
                    m && (J.height = b = {"11px,17": 14, "13px,20": 16}[`${K ||
                    ""},${Math.round(b)}`] || b);
                    if (c) {
                        m = Number(n.getAttribute("y") || 0) - J.y;
                        K = {right: 1, center: .5}[d || 0] || 0;
                        var w = c * B, l = (c - 90) * B, p = O * Math.cos(w);
                        c = O * Math.sin(w);
                        var G = Math.cos(l);
                        w = Math.sin(l);
                        O = J.x + K * (O - p) + m * G;
            ...
            setTextPath(b, c) {
                c =
                    G(!0, {enabled: !0, attributes: {dy: -5, startOffset: "50%", textAnchor: "middle"}}, c);
                const f = this.renderer.url, d = this.text || this, k = d.textPath, {attributes: n, enabled: A} = c;
                b = b || k && k.path;
                k && k.undo();
                ...
                }), d.textPath = {path: b, undo: c}) : (d.attr({dx: 0, dy: 0}), delete d.textPath);
            ...
            zIndexSetter(b, f) {
                var d = this.renderer, k = this.parentGroup;
                const n = (k || d).element || d.box, q = this.element;
                d = n === d.box;
                let A = !1, g;
                var a = this.added;
                let r;
                ...
                if (a) {
                    ...
                    !A; r--) if (k = f[r], a = k.getAttribute("data-z-index"), g = !e(a), k !== q) if (0 > b && g && !d && !r) n.insertBefore(q, f[r]), A = !0; else if (c(a) <= b || g && (!e(b) || 0 <= b)) n.insertBefore(q, f[r + 1]), A = !0;
    ...
    M(a, "Core/Renderer/SVG/SVGLabel.js", [a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function (a, y) {
        ...
        class u extends a {
            ...
            alignSetter(a) {
                ...
                a !== this.alignFactor && (this.alignFactor = a, this.bBox && C(this.xSetting) && this.attr({x: this.xSetting}))
            }
            ...
            getBBox() {
                ...
                const a = this.padding, l = H(this.paddingLeft, a);
                return {width: this.width, height: this.height, x: this.bBox.x - l, y: this.bBox.y - a}
            }
    ...
    M(a, "Core/Renderer/SVG/Symbols.js", [a["Core/Utilities.js"]], function (a) {
        function x(a, u, v, l, p) {
            ...
            if (p) {
                ...
                v = H(p.r, l || v);
                l = (p.end || 0) - .001;
                const g = p.innerR, e = H(p.open, .001 > Math.abs((p.end || 0) - m - 2 * Math.PI)), w = Math.cos(m),
                    E = Math.sin(m), F = Math.cos(l), d = Math.sin(l), k = H(p.longArc, .001 > l - m - Math.PI ? 0 : 1);
        ...
        const {defined: C, isNumber: z, pick: H} =
            a;
        return {
            arc: x, callout: function (a, u, v, l, p) {
                ...
                a + h >= v ? p > u + m && p < u + l - m ? g.splice(3, 1, ["L", a + v, p - 6], ["L", a + v + 6, p], ["L", a + v, p + 6], ["L", a + v, u + l - t]) : g.splice(3, 1, ["L", a + v, l / 2], ["L", h, p], ["L", a + v, l / 2], ["L", a + v, u + l - t]) : 0 >= a + h ? p > u + m && p < u + l - m ? g.splice(7, 1, ["L", a, p + 6], ["L", a - 6, p], ["L", a, p - 6], ["L", a, u + t]) : g.splice(7, 1, ["L", a, l / 2], ["L", h, p], ["L", a, l / 2], ["L", a, u + t]) : p && p > l && h > a + m && h < a + v - m ? g.splice(5, 1, ["L",
                    h + 6, u + l], ["L", h, u + l + 6], ["L", h - 6, u + l], ["L", a + t, u + l]) : p && 0 > p && h > a + m && h < a + v - m && g.splice(1, 1, ["L", h - 6, u], ["L", h, u - 6], ["L", h + 6, u], ["L", v - t, u]);
                return g
            }, circle: function (a, u, v, l) {
                return x(a + v / 2, u + l / 2, v / 2, l / 2, {start: .5 * Math.PI, end: 2.5 * Math.PI, open: !1})
            }, diamond: function (a, u, v, l) {
                return [["M", a + v / 2, u], ["L", a + v, u + l / 2], ["L", a + v / 2, u + l], ["L", a, u + l / 2], ["Z"]]
            }, rect: I, roundedRect: L, square: I, triangle: function (a, u, v, l) {
    ...
    M(a, "Core/Renderer/SVG/TextBuilder.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y, I) {
        ...
        class t {
            ...
            buildSVG() {
                ...
                const w = -1 !== e.indexOf("<"), l = h.childNodes;
                g = !m.added && g.box;
                const t = /<br.*?>/g;
            ...
            modifyDOM() {
                const a = this.svgElement, h = H(a.element, "x");
                a.firstLineMetrics = void 0;
                let g;
                for (; g = a.element.firstChild;) if (/^[\s\u200B]*$/.test(g.textContent ||
                    " ")) a.element.removeChild(g); else break;
            ...
            modifyTree(a) {
                const h =
                    (g, e) => {
                        const {attributes: m = {}, children: l, style: p = {}, tagName: d} = g,
    ...
    M(a, "Core/Renderer/SVG/SVGRenderer.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Renderer/RendererRegistry.js"],
        ...
        class V {
            ...
            init(b, c, f, a, k, n, J) {
                const A = this.createElement("svg").attr({version: "1.1", "class": "highcharts-root"}), e = A.element;
            ...
            getStyle(c) {
                return this.style = b({fontFamily: "Helvetica, Arial, sans-serif", fontSize: "1rem"}, c)
            }
            ...
            button(c,
                   f, d, k, e = {}, q, J, g, r, h) {
                const A = this.label(c, f, d, r, void 0, void 0, h, void 0, "button"), O = this.styledMode;
                c = e.states || {};
                let N = 0;
                e = D(e);
                delete e.states;
                const l = D({color: "#333333", cursor: "pointer", fontSize: "0.8em", fontWeight: "normal"}, e.style);
                delete e.style;
                ...
                O || (w = D({
                    ...
                    stroke: "#cccccc",
                    "stroke-width": 1
                }, w), q = D(w, {fill: "#e6e6e6"}, a.filterUserAttributes(q || c.hover || {})), p = q.style, delete q.style, J = D(w, {
                    fill: "#e6e9ff", style: {
                        color: "#000000",
                        fontWeight: "bold"
                    }
                }, a.filterUserAttributes(J || c.select || {})), G = J.style, delete J.style, g = D(w, {style: {color: "#cccccc"}}, a.filterUserAttributes(g || c.disabled || {})), R = g.style, delete g.style);
                ...
                O || (A.attr(w).css(b({cursor: "default"}, l)), h && A.text.css({pointerEvents: "none"}));
            ...
            arc(b, c, f, d, a, k) {
                n(b) ? (d = b, c = d.y, f = d.r, b = d.x) : d = {innerR: d, start: a, end: k};
            ...
            image(b, f, d, a, k, n) {
                ...
                n ? (e.attr({href: "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="}), d = new E.Image, F(d, "load", f), d.src = b, d.complete && f({})) : e.attr({href: b});
                return e
            }

            symbol(c, f, a, n, e, g) {
                const A = this, h = /^url\((.*?)\)$/, O = h.test(c), m = !O && (this.symbols[c] ? c : "circle"),
                    l = m && this.symbols[m];
                let D, G, P, t;
                if (l) "number" ===
                typeof f && (G = l.call(this.symbols, Math.round(f || 0), Math.round(a || 0), n || 0, e || 0, g)), D = this.path(G), A.styledMode || D.attr("fill", "none"), b(D, {
                    ...
                    ["width", "height"].forEach(function (c) {
                        b[c + "Setter"] = function (b, c) {
                            this[c] = b;
                            const {
                                alignByTranslate: f, element: a, width: k, height: A,
                                imgwidth: n, imgheight: e
                            } = this;
                            b = this["img" + c];
                            if (q(b)) {
                                let J = 1;
                    ...
                    q(f) && b.attr({x: f, y: a});
                    b.isImg = !0;
                    q(b.imgwidth) && q(b.imgheight) ? t(b) : (b.attr({width: 0, height: 0}), k("img", {
                        onload: function () {
            ...
            clipRect(b, c, f, d) {
                const a = T() + "-", k = this.createElement("clipPath").attr({id: a}).add(this.defs);
            ...
            text(b, c, f, d) {
                ...
                if (!d || this.forExport && !this.allowHTML) b.xSetter = function (b, c, f) {
                    const d = f.getElementsByTagName("tspan"), a = f.getAttribute(c);
            ...
            pathToSegments(b) {
                const f = [], d = [], a = {A: 8, C: 7, H: 2, L: 3, M: 3, Q: 5, S: 5, T: 3, V: 2};
    ...
    M(a, "Core/Renderer/HTML/HTMLElement.js", [a["Core/Globals.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function (a, y, I) {
        const {isFirefox: x, isMS: C, isWebKit: z, win: H} = a, {css: B, defined: u, extend: v, pick: l, pInt: p} = I,
            t = [];

        class m extends y {
            static compose(a) {
                if (I.pushUnique(t, a)) {
                    const g = m.prototype, e = a.prototype;
            ...
            htmlCss(a) {
                const g = "SPAN" === this.element.tagName && a && "width" in a, e = l(g && a.width, void 0);
                let h;
            ...
            htmlUpdateTransform() {
                if (this.added) {
                    var a = this.renderer, g = this.element, e = this.x || 0, m = this.y || 0,
                        l = this.textAlign || "left", t = {left: 0, center: .5, right: 1}[l], d = this.styles,
                        k = d && d.whiteSpace;
                    ...
                    if ("SPAN" === g.tagName) {
                        ...
                        if (q !== this.oldTextWidth) {
                            if (this.textPxLength) var r =
                                this.textPxLength; else B(g, {width: "", whiteSpace: k || "nowrap"}), r = g.offsetWidth;
                        ...
                        B(g, {left: e + (this.xCorr || 0) + "px", top: m + (this.yCorr || 0) + "px"});
                        this.cTT = h;
                        this.oldRotation = d;
                        this.oldAlign = l
                    }
                    ...
                    if (this.parentGroup = a) {
                        if (d = a.div, !d) {
                            ...
                            w.reverse().forEach(function (a) {
                                ...
                                const q = x(a.element, "class"), g = a.styles || {};
                                d = a.div = a.div || z("div", q ? {className: q} : void 0, {
                                    position: "absolute",
                                    left: (a.translateX ||
                                        0) + "px",
                                ...
                                H(a, {
                                    classSetter: function (b) {
                                        ...
                                        w[0].div && m.on.apply({element: w[0].div, onEvents: a.onEvents}, arguments);
                                        return a
    ...
    M(a, "Core/Axis/AxisDefaults.js", [], function () {
        ...
        (function (a) {
            ...
            a.defaultBottomAxisOptions =
                {labels: {autoRotation: [-45]}, margin: 15, title: {rotation: 0}};
    ...
    M(a, "Core/Axis/Tick.js", [a["Core/Templating.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y, I) {
        ...
        class h {
            ...
            addLabel() {
                ...
                const p = e.chart;
                var t = e.categories;
                const d = e.logarithmic, k = e.names, r = g.pos, q = m(g.options && g.options.labels, h.labels);
                ...
                g.shortenLabel = y ? function () {
                    for (K = 0; K < y.length; K++) if (u(x,
                        {dateTimeLabelFormat: y[K]}), n.attr({text: B.call(x, x)}), n.getBBox().width < e.getSlotWidth(g) - 2 * q.padding) return;
                    n.attr({text: ""})
                } : void 0;
                c && e._addedPlotLB && g.moveLabel(h, q);
                H(n) || g.movedLabel ? n && n.textStr !== h && !c && (!n.textWidth || q.style.width || n.styles.width || n.css({width: null}), n.attr({text: h}), n.textPxLength = n.getBBox().width) : (g.label = n = g.createLabel({
                    x: 0,
                    y: 0
                }, h, q), g.rotation = 0)
            }
            ...
            getPosition(a, e, h, m) {
                const g = this.axis, d = g.chart, k = m && d.oldChartHeight || d.chartHeight;
                a = {
            ...
            getLabelPosition(a,
                             e, h, l, p, d, k, r) {
                const q = this.axis, g = q.transA,
                    b = q.isLinked && q.linkedParent ? q.linkedParent.reversed : q.reversed, f = q.staggerLines,
            ...
            handleOverflow(a) {
                const e = this.axis, g = e.options.labels, h = a.x;
                var l = e.chart.chartWidth, d = e.chart.spacing;
                const k = m(e.labelLeft, Math.min(e.pos, d[3]));
                d = m(e.labelRight, Math.max(e.isRadial ?
                    0 : e.pos + e.len, l - d[1]));
                const r = this.label, q = this.rotation,
                    p = {left: 0, center: .5, right: 1}[e.labelAlign || r.attr("align")], b = r.getBBox().width,
                    f = e.getSlotWidth(this), c = {};
                let n = f, t = 1, D;
            ...
            moveLabel(a, e) {
                ...
                d || !g.labelPos && !h || (h = g.labelPos || h.xy, g.movedLabel = g.createLabel(h, a, e), g.movedLabel && g.movedLabel.attr({opacity: 0}))
            }

            render(a,
                   e, h) {
                var g = this.axis, l = g.horiz, d = this.pos, k = m(this.tickmarkOffset, g.tickmarkOffset);
            ...
            renderGridLine(a, e, h) {
                const g = this.axis, l = g.options, d = {}, k = this.pos, r = this.type,
                    q = m(this.tickmarkOffset, g.tickmarkOffset), p = g.chart.renderer;
                let b = this.gridLine,
                    f = l.gridLineWidth, c = l.gridLineColor, n = l.gridLineDashStyle;
            ...
            renderMark(a,
                ...
                const g = this.axis;
                var l = g.options;
                const d = g.chart.renderer, k = this.type, r = g.tickSize(k ? k + "Tick" : "tick"), q = a.x;
                a = a.y;
            ...
            renderLabel(a, e, h, p) {
                var g = this.axis;
                const d = g.horiz, k = g.options, r = this.label, q = k.labels, t = q.step;
                g = m(this.tickmarkOffset, g.tickmarkOffset);
                const b = a.x;
                a = a.y;
                let f = !0;
                r && l(b) && (r.xy = a = this.getLabelPosition(b, a, r, d, q, g, p, t), this.isFirst && !this.isLast && !k.showFirstLabel || this.isLast && !this.isFirst && !k.showLastLabel ? f = !1 : !d || q.step || q.rotation || e || 0 === h || this.handleOverflow(a), t && p % t && (f = !1), f && l(a.y) ? (a.opacity = h, r[this.isNewLabel ? "attr" : "animate"](a).show(!0), this.isNewLabel =
                    !1) : (r.hide(), this.isNewLabel = !0))
            }

            replaceMovedLabel() {
                const a = this.label, e = this.axis;
                a && !this.isNew && (a.animate({opacity: 0}, void 0, a.destroy), delete this.label);
                e.isDirty = !0;
    ...
    M(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/AxisDefaults.js"], a["Core/Color/Color.js"], a["Core/Defaults.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Axis/Tick.js"], a["Core/Utilities.js"]], function (a, y, I, L, C, z, H, B) {
        const {animObject: u} =
                a, {defaultOptions: v} = L, {registerEventOptions: l} = C, {deg2rad: p} = z, {
                arrayMax: t,
                arrayMin: m,
                clamp: h,
                correctFloat: g,
        ...
        class Y {
            ...
            defaultLabelFormatter(c) {
                ...
                const a = b(this.value) ? this.value : NaN, d = f.chart.time, k = this.dateTimeLabelFormat;
                var n = v.lang;
            ...
            translate(c, f, a, d, k, n) {
                const e = this.linkedParent || this, A = d && e.old ? e.old.min : e.min;
                if (!b(A)) return NaN;
            ...
            getPlotLinePath(c) {
                ...
                const a = this,
                    d = a.chart, n = a.left, e = a.top, A = c.old, q = c.value, g = c.lineWidth,
                    r = A && d.oldChartHeight || d.chartHeight, m = A && d.oldChartWidth || d.chartWidth, l = a.transB;
                let p = c.translatedValue, t = c.force, P, w, R, Q, K;
                c = {value: q, lineWidth: g, old: A, force: t, acrossPanes: c.acrossPanes, translatedValue: p};
            ...
            adjustForMinRange() {
                const b = this.options, c = this.logarithmic;
                let f = this.min;
                var a = this.max;
                let d, k;
            ...
            getClosest() {
                ...
                if (this.categories) c = 1; else {
                    ...
                    this.series.forEach(function (b) {
                        var a;
                        const d = b.closestPointRange, k = b.visible || !b.chart.options.chart.ignoreHiddenSeries;
            ...
            nameToX(b) {
                const c = G(this.options.categories), f = c ? this.categories : this.names;
                let a = b.options.x, d;
            ...
            setAxisTranslation() {
                const b = this, c = b.max - b.min;
                var a = b.linkedParent;
                const d = !!b.categories,
                    n = b.isXAxis;
                let e = b.axisPointRange || 0, q, g = 0, h = 0, r = b.transA;
            ...
            setTickInterval(c) {
                var f = this.chart;
                const a = this.logarithmic, d = this.options, n = this.isXAxis, q = this.isLinked,
                    h = d.tickPixelInterval, A = this.categories, r = this.softThreshold;
                let m = d.maxPadding, l = d.minPadding;
                let p = b(d.tickInterval) && 0 <= d.tickInterval ? d.tickInterval : void 0, t = b(this.threshold) ?
                    this.threshold : null, P, w, K;
            ...
            setTickPositions() {
                var c = this.options;
                const f = c.tickPositions, a = c.tickPositioner;
                var d = this.getMinorTickInterval(), n = this.hasVerticalPanning(), q = "colorAxis" === this.coll;
                ...
                if (f) q = f.slice(); else if (b(this.min) && b(this.max)) {
                    if (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))) if (this.dateTime) q = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, c.units), this.min, this.max, c.startOfWeek, this.ordinal && this.ordinal.positions,
                        this.closestPointRange, !0); else if (this.logarithmic) q = this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max); else for (d = c = this.tickInterval; d <= 2 * c;) if (q = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && q.length > this.tickAmount) this.tickInterval = V(this, d *= 1.1); else break; else q = [this.min, this.max], F(19, !1, this.chart);
            ...
            trimTicks(b, c, f) {
                const a = b[0], d = b[b.length - 1], n = !this.isOrdinal && this.minPointOffset || 0;
                k(this, "trimTicks");
                if (!this.isLinked) {
            ...
            alignToOthers() {
                const c = this, f = [this], a = c.options,
                    d = "yAxis" === this.coll && this.chart.options.chart.alignThresholds, k = [];
                let n;
            ...
            getTickAmount() {
                const b = this.options, c = b.tickPixelInterval;
                let f = b.tickAmount;
            ...
            zoom(b, c) {
                const f = this, a = this.dataMin, d = this.dataMax, n = this.options, q = Math.min(a, D(n.min, a)),
                    g = Math.max(d, D(n.max, d));
                b = {newMin: b, newMax: c};
                k(this, "zoom", b, function (b) {
                    let c = b.newMin, n = b.newMax;
                    if (c !== f.min || n !== f.max) f.allowZoomOutside || (e(a) && (c < q && (c = q), c > g && (c = g)), e(d) && (n < q && (n = q), n > g && (n = g))), f.displayBtn =
                        "undefined" !== typeof c || "undefined" !== typeof n, f.setExtremes(c, n, !1, void 0, {trigger: "zoom"});
                    b.zoomed = !0
                });
                return b.zoomed
            }
            ...
            setAxisSize() {
                const b = this.chart;
                var c = this.options;
                const f = c.offsets || [0, 0, 0, 0], a = this.horiz,
            ...
            tickSize(b) {
                ...
                let a = c["tick" === b ? "tickLength" : "minorTickLength"], d;
            ...
            unsquish() {
                ...
                var f = this.horiz;
                const a = this.tickInterval, d = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / a),
                    n = c.rotation, k = .75 * this.labelMetrics().h, e = Math.max(this.max - this.min, 0),
                    q = function (b) {
                        let c = b / (d || 1);
                        c = 1 < c ? Math.ceil(c) : 1;
                ...
                let h = a, r, l = Number.MAX_VALUE, m;
                if (f) {
                    if (c.staggerLines ||
            ...
            getSlotWidth(c) {
                const f = this.chart, a = this.horiz, d = this.options.labels,
                    n = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), k = f.margin[3];
            ...
            renderUnsquish() {
                const b = this.chart, c = b.renderer, a = this.tickPositions, d = this.ticks, n = this.options.labels,
                    k = n.style, e = this.horiz, q = this.getSlotWidth();
                var g = Math.max(1, Math.round(q - 2 * n.padding));
                const h = {}, r = this.labelMetrics(), m = k.textOverflow;
                let l, p, D = 0;
                ...
                if (this.autoRotation) D > g && D > r.h ? h.rotation = this.labelRotation : this.labelRotation = 0; else if (q && (l = g, !m)) for (p = "clip", g = a.length; !e && g--;) {
                    var t = a[g];
                    if (t = d[t].label) t.styles && "ellipsis" === t.styles.textOverflow ? t.css({textOverflow: "clip"}) : t.textPxLength > q && t.css({width: q + "px"}), t.getBBox().height > this.len / a.length - (r.h - r.f) && (t.specificTextOverflow = "ellipsis")
                }
                ...
                a.forEach(function (b) {
                    const c = (b = d[b]) && b.label, f = k.width, a = {};
                    c && (c.attr(h), b.shortenLabel ? b.shortenLabel() : l && !f && "nowrap" !== k.whiteSpace && (l < c.textPxLength || "SPAN" === c.element.tagName) ? (a.width = l + "px", m || (a.textOverflow = c.specificTextOverflow || p), c.css(a)) : c.styles && c.styles.width && !a.width && !f && c.css({width: null}), delete c.specificTextOverflow, b.rotation = h.rotation)
                }, this);
            ...
            addTitle(b) {
                const f = this.chart.renderer, a = this.horiz, d = this.opposite, n = this.options.title,
                ...
                k || n.style.width || this.isRadial || this.axisTitle.css({width: this.len + "px"});
            ...
            getOffset() {
                const c = this, {
                    ...
                    coll: h,
                    axisParent: r
                } = c, m = f.renderer, l = f.inverted && !c.isZAxis ? [1, 0, 3, 2][n] : n;
                var p = c.hasData();
                const t =
                    d.title;
                var w = d.labels;
                ...
                var G = f.axisOffset;
                const R = f.clipOffset, Q = [-1, 1, 1, -1][n], v = d.className;
                let ja, u = 0, x;
                var E = 0;
                let F = 0;
                ...
                if (!c.axisGroup) {
                    const b = (b, c, f) => m.g(b).attr({zIndex: f}).addClass(`highcharts-${h.toLowerCase()}${c} ` + (this.isRadial ? `highcharts-radial-axis${c} ` : "") + (v || "")).add(r);
            ...
            getLinePath(b) {
                const c = this.chart, f = this.opposite;
                var a = this.offset;
                const d = this.horiz, n = this.left + (f ? this.width : 0) + a;
            ...
            getTitlePosition(b) {
                var c = this.horiz, f = this.left;
                const a = this.top;
                var d = this.len;
                const n = this.options.title, e = c ? f : a, q = this.opposite, g = this.offset, h = n.x, r = n.y,
                ...
                c = {x: c ? d + h : f + (q ? this.width : 0) + g + h, y: c ? f + r - (q ? this.height : 0) + g : d + r};
            ...
            render() {
                const c = this, f = c.chart, a = c.logarithmic, d = c.options, n = c.isLinked, e = c.tickPositions,
                    q = c.axisTitle, g = c.ticks, h = c.minorTicks, r = c.alternateBands, l = d.stackLabels,
                    m = d.alternateGridColor;
                var p = d.crossing;
                const D = c.tickmarkOffset, t = c.axisLine, w = c.showAxis, K = u(f.renderer.globalAnimation);
                let Q, G;
                ...
                t && (t[t.isPlaced ? "animate" : "attr"]({d: this.getLinePath(t.strokeWidth())}), t.isPlaced = !0, t[w ? "show" : "hide"](w));
            ...
            destroy(b) {
                const c = this, f = c.plotLinesAndBands, a = this.eventOptions;
            ...
            drawCrosshair(b, c) {
                ...
                if (f && !1 !== (e(c) || !a)) {
                    ...
                    if (e(q)) {
                        ...
                        n.polar && d(h, {isCrosshair: !0, chartX: b && b.chartX, chartY: b && b.chartY, point: c});
                    ...
                    g || (this.cross = g = n.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (a ? "category " : "thin ") + (f.className || "")).attr({zIndex: D(f.zIndex, 2)}).add(), n.styledMode || (g.attr({
                        stroke: f.color || (a ? I.parse("#ccd3ff").setOpacity(.25).get() : "#cccccc"),
                        "stroke-width": D(f.width,
                            1)
                    }).css({"pointer-events": "none"}), f.dashStyle && g.attr({dashstyle: f.dashStyle})));
                    g.show().attr({d: h});
            ...
            remove(b) {
                const c = this.chart, f = this.coll, a = this.series;
                let d = a.length;
    ...
    M(a, "Core/Axis/DateTimeAxis.js", [a["Core/Utilities.js"]],
        function (a) {
            const {addEvent: x, getMagnitude: I, normalizeTickInterval: L, timeUnits: C} = a;
            var z;
            (function (y) {
                function B() {
                ...
                class l {
                    ...
                    normalizeTimeTickInterval(a, l) {
                        const m =
                            l || [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1, 2]], ["week", [1, 2]], ["month", [1, 2, 3, 4, 6]], ["year", null]];
                        l = m[m.length - 1];
                        let h = C[l[0]], g = l[1], e;
    ...
    M(a, "Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js", [a["Core/Utilities.js"]], function (a) {
        ...
        (function (y) {
            ...
            function v(a, e, h = this.options) {
                const g = this.getPlotLinePath({value: e, force: !0, acrossPanes: h.acrossPanes}), l = [],
                    d = this.horiz;
            ...
            function p(a) {
                const e = this.plotLinesAndBands, g = this.options, h = this.userOptions;
                if (e) {
                    let l = e.length;
                    for (; l--;) e[l].id === a && e[l].destroy();
                    [g.plotLines || [], h.plotLines || [],
                        g.plotBands || [], h.plotBands || []].forEach(function (d) {
    ...
    M(a, "Core/Axis/PlotLineOrBand/PlotLineOrBand.js", [a["Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js"], a["Core/Utilities.js"]],
        function (a, y) {
            ...
            class p {
                ...
                render() {
                    B(this, "render");
                    const a = this, m = a.axis, h = m.horiz;
                    var g = m.logarithmic;
                    const e = a.options, p = e.color, x = l(e.zIndex, 0), F = e.events, d = {}, k = m.chart.renderer;
                    let r = e.label, q = a.label, G = e.to, b = e.from, f = e.value, c = a.svgElem;
                    var n = [];
                    const P = C(b) && C(G);
                    n = C(f);
                    const D =
                        !c, K = {"class": "highcharts-plot-" + (P ? "band " : "line ") + (e.className || "")};
                    let X = P ? "bands" : "lines";
                    ...
                    (D || !c.d) && n && n.length ? c.attr({d: n}) : c && (n ? (c.show(), c.animate({d: n})) : c.d && (c.hide(), q && (a.label = q = q.destroy())));
                ...
                renderLabel(a, l, h, g) {
                    ...
                    p || (this.label = p = m.text(this.getLabelText(a), 0, 0, a.useHTML).attr({
                        ...
                        zIndex: g
                    }).add(), e.chart.styledMode || p.css(u({fontSize: "0.8em", textOverflow: "ellipsis"}, a.style)));
                    ...
                    p.alignValue && "left" !== p.alignValue || (a = a.clip ? e.width : e.chart.chartWidth, p.css({width: (90 === p.rotation ? e.height - (p.alignAttr.y - e.top) : a - (p.alignAttr.x - e.left)) + "px"}));
                    p.show(!0)
                }
    ...
    M(a, "Core/Tooltip.js", [a["Core/Templating.js"], a["Core/Globals.js"],
        ...
        const {format: x} = a, {doc: H, isSafari: B} = y, {distribute: u} = I, {
            addEvent: v,
            clamp: l,
            css: p,
            discardElement: t,
        ...
        class r {
            ...
            getAnchor(a, k) {
                ...
                typeof k.chartX && (k = f.normalize(k)), a = [k.chartX - b, k.chartY - n]; else if (a[0].tooltipPos) a = a[0].tooltipPos; else {
                    let f = 0, d = 0;
                    a.forEach(function (b) {
            ...
            getLabel() {
                const a = this, d = this.chart.styledMode, b = this.options, f = this.split && this.allowShared,
                ...
                if (!this.label) {
                    ...
                    }).css(b.style).css({pointerEvents: c}));
                    if (a.outside) {
                        const b = this.label, {
                            xSetter: c,
                            ySetter: f
            ...
            getPlayingField() {
                const {body: a, documentElement: d} = H, {chart: b, distance: f, outside: c} = this;
                return {
                    width: c ? Math.max(a.scrollWidth, d.scrollWidth, a.offsetWidth, d.offsetWidth, d.clientWidth) - 2 * f : b.chartWidth,
                    height: c ? Math.max(a.scrollHeight, d.scrollHeight, a.offsetHeight, d.offsetHeight, d.clientHeight) :
                        b.chartHeight
                }
            }

            getPosition(a, d, b) {
                const f = this.chart, c = this.distance, n = {}, k = f.inverted && b.h || 0, e = this.outside;
                var q = this.getPlayingField();
                const g = q.width, h = q.height, r = f.pointer.getChartPosition();
                q = n => {
                    const k = "x" === n;
                ...
                const t = !this.followPointer && F(b.ttBelow, !f.inverted === q), w = function (b, a, f, d, q, g, h) {
                    const l = e ? "y" === b ? c * r.scaleY : c * r.scaleX : c, m = (f - d) / 2, p = d < q - c,
                        J = q + c + d < a, D = q - l - f + m;
                    q = q + l - m;
            ...
            refresh(a, k) {
                const b = this.chart, f = this.options, c = b.pointer, n = d(a), e = n[0], q = [];
                var r = f.format, l = f.formatter || this.defaultFormatter;
                const m = this.shared, p = b.styledMode;
                let t = {};
                    ...
                    if (!1 === r) this.hide(); else {
                        if (this.split && this.allowShared) this.renderSplit(r, n); else {
                            ...
                            if (b.polar || !1 === l.options.clip || n.some(b => c.isDirectTouch || b.series.shouldShowTooltip(d,
                                g))) k = this.getLabel(), f.style.width && !p || k.css({width: (this.outside ? this.getPlayingField() : b.spacingBox).width + "px"}), k.attr({text: r && r.join ? r.join("") : r}), k.addClass(this.getClassName(e), !0), p || k.attr({stroke: f.borderColor || e.color || l.color || "#666666"}), this.updatePosition({
                                plotX: v,
                                plotY: G,
                                negative: e.negative,
                                ttBelow: e.ttBelow,
            ...
            renderSplit(a, d) {
                ...
                const f = this, {
                        ...
                        chart: {
                            ...
                            scrollablePixelsX: p,
                            scrollingContainer: {scrollLeft: t, scrollTop: v} = {scrollLeft: 0, scrollTop: 0},
                            styledMode: G
                        },
                        distance: x,
                        options: E,
                        options: {positioner: y}
                    } = f, J = f.outside && "number" !== typeof p ? H.documentElement.getBoundingClientRect() : {
                        left: t, right: t + n, top: v,
                        bottom: v + k
                    }, N = f.getLabel(), O = this.renderer || c.renderer,
                    S = !(!c.xAxis[0] || !c.xAxis[0].opposite), {left: W, top: ha} = q.getChartPosition();
                let da = h + v, C = 0, z = e - r;
                w(a) && (a = [!1, a]);
                a = a.slice(0, d.length + 1).reduce(function (c, a, n) {
                    if (!1 !== a && "" !== a) {
                        n = d[n - 1] || {isHeader: !0, plotX: d[0].plotX, plotY: e, series: {}};
                        const D = n.isHeader;
                        var k = D ? f : n.series, q;
                        {
                            var r = n;
                            a = a.toString();
                            var m = k.tt;
                            ...
                            m.isActive = !0;
                            m.attr({text: a});
                            G || m.css(E.style).attr({stroke: E.borderColor || r.color || c.color || "#333333"});
                            q = m
                        }
                        q = k.tt = q;
                        r = q.getBBox();
                        ...
                        {
                            const {isHeader: b, plotX: c = 0, plotY: f = 0, series: d} = n;
                            if (b) {
                                a = g + c;
                                var p = h + e / 2
                            } else {
                ...
                a.forEach(function (b) {
                    const {x: c, anchorX: a, anchorY: d, pos: n, point: {isHeader: k}} = b, e = {
                ...
                B && N.attr({opacity: 1 === N.opacity ? .999 : 1})
            }

            drawTracker() {
                if (this.shouldStickOnContact()) {
                    var a = this.chart, d = this.label, b = this.shared ? a.hoverPoints : a.hoverPoint;
                    if (d && b) {
                        ...
                        this.tracker ? this.tracker.attr(f) : (this.tracker = d.renderer.rect(f).addClass("highcharts-tracker").add(d), a.styledMode || this.tracker.attr({fill: "rgba(0,0,0,0)"}))
                    }
            ...
            tooltipFooterHeaderFormatter(a, d) {
                ...
                let k = f.xDateFormat, g = f[d ? "footerFormat" : "headerFormat"];
            ...
            updatePosition(a) {
                ...
                var c = d.pointer;
                const n = this.getLabel(), {left: k, top: e, scaleX: g, scaleY: h} = c.getChartPosition();
                ...
                if (this.outside) {
                    ...
                    if (1 !== g || 1 !== h) p(this.container, {transform: `scale(${g}, ${h})`}), q *= g, a *= h;
                    q += k - c.x;
                    a += e - c.y
                }
    ...
    M(a, "Core/Series/Point.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Animation/AnimationUtilities.js"],
        ...
        const {animObject: x} = y, {defaultOptions: H} = I, {format: B} = L, {
            addEvent: u,
            defined: v,
            erase: l,
            extend: p,
        ...
        class G {
            ...
            animateBeforeDestroy() {
                const b = this, a = {x: b.startXPos, opacity: 0}, c = b.getGraphicalProps();
                c.singular.forEach(function (c) {
                    b[c] = b[c].animate("dataLabel" === c ? {x: b[c].startXPos, y: b[c].startYPos, opacity: 0} : a)
                });
                c.plural.forEach(function (c) {
                    b[c].forEach(function (c) {
                        c.element && c.animate(p({x: b.startXPos}, c.startYPos ? {x: c.startXPos, y: c.startYPos} : {}))
                    })
                })
            }
            ...
            destroy() {
                if (!this.destroyed) {
                    ...
                    const d = c.hoverPoints, e = x(a.series.chart.renderer.globalAnimation), g = () => {
            ...
            firePointEvent(b, a, c) {
                const f = this, d = this.series.options;
            ...
            getGraphicalProps(b) {
                const a = this, c = [], d = {singular: [], plural: []};
                let k, e;
            ...
            optionsToObject(b) {
                var a = this.series;
                const c = a.options.keys, d = c || a.pointArrayMap || ["y"], k = d.length;
                let g = {}, q = 0, r = 0;
                if (e(b) || null === b) g[d[0]] = b; else if (h(b)) for (!c && b.length > k && (a = typeof b[0], "string" === a ? g.name = b[0] : "number" === a && (g.x = b[0]), q++); r < k;) c && "undefined" === typeof b[q] || (0 < d[r].indexOf(".") ? G.prototype.setNestedProperty(g, b[q], d[r]) : g[d[r]] = b[q]), q++, r++; else "object" === typeof b && (g = b, b.dataLabels &&
            ...
            pos(b, a = this.plotY) {
                if (!this.destroyed) {
                    const {plotX: c, series: f} = this, {chart: d, xAxis: k, yAxis: g} = f;
                    let h = 0, q = 0;
            ...
            tooltipFormatter(b) {
                const a = this.series, c = a.tooltipOptions, k = d(c.valueDecimals, ""), e = c.valuePrefix || "",
                    g = c.valueSuffix || "";
                a.chart.styledMode &&
            ...
            update(b, a, c, k) {
                ...
                const n = this, e = n.series, g = n.graphic, h = e.chart, q = e.options;
                let r;
                a = d(a, !0);
            ...
            select(b, a) {
                const c = this, f = c.series, k = f.chart;
                this.selectedStaging = b = d(b, !c.selected);
                c.firePointEvent(b ? "select" : "unselect", {accumulate: a}, function () {
            ...
            onMouseOver(b) {
                const a = this.series.chart, c = a.pointer;
            ...
            importEvents() {
                if (!this.hasImportedEvents) {
                    const b = this, a = E(b.series.options.point, b.options).events;
                    b.events = a;
                    F(a, function (c, a) {
                        g(c) &&
                        u(b, a, c)
            ...
            setState(b, f) {
                const c = this.series;
                var k = this.state, g = c.options.states[b || "normal"] || {},
                    h = H.plotOptions[c.type].marker && c.options.marker;
                const q = h && !1 === h.enabled, r = h && h.states && h.states[b || "normal"] || {},
                    l = !1 === r.enabled, m = this.marker || {}, w = c.chart, v = h && c.markerAttribs;
                let G = c.halo;
                var u;
                let x;
                ...
                if (!(b === this.state && !f || this.selected && "select" !== b || !1 === g.enabled || b && (l || q && !1 === r.enabled) || b && m.states && m.states[b] && !1 === m.states[b].enabled)) {
                    ...
                    if (this.graphic && !this.hasMockGraphic) {
                        ...
                        if (!w.styledMode) {
                            ...
                            c.options.inactiveOtherPoints && e(a) && ((this.dataLabels || []).forEach(function (b) {
                                b && !b.hasClass("highcharts-data-label-hidden") && b.animate({opacity: a}, x)
                    ...
                    g && g.size && E && "hidden" !== u && !this.isCluster ? (G || (c.halo = G = w.renderer.path().add(E.parentGroup)), G.show()[f ? "animate" : "attr"]({d: this.haloPath(g.size)}), G.attr({
    ...
    M(a, "Core/Pointer.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, y, I) {
        const {parse: x} = a, {charts: C, noop: z} = y, {
            addEvent: H,
            attr: B,
            css: u,
            defined: v,
        ...
        class F {
            ...
            getSelectionMarkerAttrs(a, k) {
                const d = {args: {chartX: a, chartY: k}, attrs: {}, shapeType: "rect"};
            ...
            drag(a) {
                const d = this.chart, e = d.options.chart;
                var g = d.plotLeft;
                const l = d.plotTop, b = d.plotWidth, f = d.plotHeight, c = this.mouseDownX || 0,
                    n = this.mouseDownY || 0, m = h(e.panning) ? e.panning && e.panning.enabled : e.panning,
                    p = e.panKey && a[e.panKey + "Key"];
                let t = a.chartX, w = a.chartY, v = this.selectionMarker;
                if (!v || !v.touch) if (t <
                g ? t = g : t > g + b && (t = g + b), w < l ? w = l : w > l + f && (w = l + f), this.hasDragged = Math.sqrt(Math.pow(c - t, 2) + Math.pow(n - w, 2)), 10 < this.hasDragged) {
                    ...
                    const {shapeType: b, attrs: f} = this.getSelectionMarkerAttrs(t, w);
                    !d.hasCartesianSeries && !d.mapView || !this.zoomX && !this.zoomY || !g || p || v || (this.selectionMarker = v = d.renderer[b](), v.attr({
                        "class": "highcharts-selection-marker",
                        zIndex: 7
                    }).add(), d.styledMode || v.attr({fill: e.selectionMarkerFill || x("#334eff").setOpacity(.25).get()}));
                    v && v.attr(f);
            ...
            drop(a) {
                const d = this, e = this.chart, g = this.hasPinched;
                if (this.selectionMarker) {
                    const {
                            x: k,
                            y: b, width: f, height: c
                        } = this.getSelectionBox(this.selectionMarker),
                        n = {originalEvent: a, xAxis: [], yAxis: [], x: k, y: b, width: f, height: c};
                    let h = !!e.mapView;
                    if (this.hasDragged || g) e.axes.forEach(function (e) {
                        if (e.zoomEnabled && v(e.min) && (g || d[{
                            ...
                            var q = e.horiz;
                            const d = "touchend" === a.type ? e.minPixelPadding : 0, g = e.toValue((q ? k : b) + d);
                            q = e.toValue((q ? k + f : b + c) - d);
                            n[e.coll].push({axis: e, min: Math.min(g, q), max: Math.max(g, q)});
                            h = !0
                        }
            ...
            findNearestKDPoint(a, k, e) {
                ...
                a.forEach(function (a) {
                    ...
                    if ((b = h(a, !0) && a.series) && !(b = !h(d, !0))) {
                        {
                            b = d.distX - a.distX;
                            const f = d.dist - a.dist, c = (a.series.group &&
            ...
            getChartCoordinatesFromPoint(a, k) {
                ...
                const g = a.shapeArgs;
                if (e && d) {
                    let b = w(a.clientX, a.plotX), f = a.plotY || 0;
                    a.isNode && g && m(g.x) && m(g.y) && (b = g.x, f = g.y);
                    return k ? {chartX: d.len + d.pos - f, chartY: e.len + e.pos - b} : {
                        chartX: b + e.pos,
                        chartY: f + d.pos
                    }
                }
            ...
            getCoordinates(a) {
                ...
                this.chart.axes.forEach(function (k) {
                    d[k.isXAxis ? "xAxis" : "yAxis"].push({axis: k, value: k.toValue(a[k.horiz ? "chartX" : "chartY"])})
                });
                return d
            }
            ...
            getHoverData(a, k, e, g, l, b) {
                ...
                let d, q = {chartX: b ? b.chartX : void 0, chartY: b ? b.chartY : void 0, shared: l};
            ...
            normalize(a, k) {
                var d = a.touches, e = d ? d.length ? d.item(0) : w(d.changedTouches, a.changedTouches)[0] : a;
            ...
            onContainerClick(a) {
                const d = this.chart, e = d.hoverPoint;
                a = this.normalize(a);
                const g = d.plotLeft, h = d.plotTop;
                d.cancelClick || (e && this.inClass(a.target, "highcharts-tracker") ? (t(e.series, "click", l(a, {point: e})), d.hoverPoint && e.firePointEvent("click", a)) : (l(a, this.getCoordinates(a)), d.isInsidePlot(a.chartX - g, a.chartY - h, {visiblePlotOnly: !0}) && t(d, "click", a)))
            }
            ...
            onContainerMouseMove(a) {
                const d = this.chart, e = d.tooltip;
                a = this.normalize(a);
                this.setHoverChartIndex();
                ("mousedown" === d.mouseIsDown || this.touchSelect(a)) && this.drag(a);
                d.openMenu || !this.inClass(a.target, "highcharts-tracker") && !d.isInsidePlot(a.chartX - d.plotLeft, a.chartY - d.plotTop, {visiblePlotOnly: !0}) || e && e.shouldStickOnContact(a) || (this.inClass(a.target, "highcharts-no-tooltip") ? this.reset(!1, 0) : this.runPointActions(a))
            }
            ...
            onDocumentMouseMove(a) {
                const d = this.chart, e = d.tooltip, g = this.chartPosition;
                a = this.normalize(a, g);
                !g || d.isInsidePlot(a.chartX - d.plotLeft, a.chartY - d.plotTop, {visiblePlotOnly: !0}) || e && e.shouldStickOnContact(a) || this.inClass(a.target, "highcharts-tracker") || this.reset()
            }
            ...
            pinch(a) {
                const d = this, e = d.chart, g = d.pinchDown, h = a.touches || [], b = h.length, f = d.lastValidTouch,
                    c = d.hasZoom, n = {}, m = 1 === b &&
                        (d.inClass(a.target, "highcharts-tracker") && e.runTrackerClick || d.runChartClick), p = {};
                ...
                "touchstart" === a.type ? ([].forEach.call(h, function (b, a) {
                    ...
                    if (b.zoomEnabled) {
                        const a =
                                e.bounds[b.horiz ? "h" : "v"], c = b.minPixelPadding,
                            f = b.toPixels(Math.min(w(b.options.min, b.dataMin), b.dataMin)),
                            d = b.toPixels(Math.max(w(b.options.max, b.dataMax), b.dataMax)), n = Math.max(f, d);
                        a.min = Math.min(b.pos, Math.min(f, d) - c);
                        a.max = Math.max(b.pos + b.len, n + c)
                    }
                }), d.res = !0) : v ? this.runPointActions(d.normalize(a)) : g.length && (t(e, "touchpan", {originalEvent: a}, () => {
                    u || (d.selectionMarker = u = l({destroy: z, touch: !0}, e.plotBox));
            ...
            pinchTranslateDirection(a, e, g, h, l, b, f, c) {
                const d = this.chart, k = a ? "x" : "y", q = a ? "X" : "Y", m = "chart" + q, r = a ? "width" : "height",
                    p = d["plot" + (a ? "Left" : "Top")], t = d.inverted, w = d.bounds[a ? "h" : "v"],
                    v = 1 === e.length, u = e[0][m], x = !v && e[1][m];
                e = function () {
                ...
                let G, E, F = c || 1, J = g[0][m], N = !v && g[1][m], O;
                e();
                g = E;
            ...
            reset(a, e) {
                const d = this.chart, k = d.hoverSeries, g = d.hoverPoint, b = d.hoverPoints, f = d.tooltip,
                    c = f && f.shared ? b : g;
            ...
            runPointActions(a, e, g) {
                const d = this.chart, k = d.tooltip && d.tooltip.options.enabled ? d.tooltip : void 0,
                    b = k ? k.shared : !1;
                let f = e || d.hoverPoint, c = f && f.series || d.hoverSeries;
                ...
                } else e && k && !k.isHidden && (g = k.getAnchor([{}], a), d.isInsidePlot(g[0], g[1], {visiblePlotOnly: !0}) && k.updatePosition({
                    plotX: g[0],
                    plotY: g[1]
                }));
            ...
            setDOMEvents() {
                const a = this.chart.container, e = a.ownerDocument;
                ...
                y.hasTouch && (this.eventsToUnbind.push(H(a, "touchstart", this.onContainerTouchStart.bind(this), {passive: !1})), this.eventsToUnbind.push(H(a, "touchmove", this.onContainerTouchMove.bind(this),
                    {passive: !1})), F.unbindDocumentTouchEnd || (F.unbindDocumentTouchEnd = H(e, "touchend", this.onDocumentTouchEnd.bind(this), {passive: !1})))
            }

            setHoverChartIndex() {
                const a = this.chart, e = y.charts[w(F.hoverChartIndex, -1)];
                if (e && e !== a) e.pointer.onContainerMouseLeave({relatedTarget: a.container});
            ...
            touch(a, e) {
                ...
                let g, k;
                this.setHoverChartIndex();
                1 === a.touches.length ? (a = this.normalize(a), (k = d.isInsidePlot(a.chartX - d.plotLeft, a.chartY - d.plotTop, {visiblePlotOnly: !0})) &&
            ...
            zoomOption(a) {
                const d = this.chart, e = d.inverted;
    ...
    M(a, "Core/Legend/Legend.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Templating.js"], a["Core/Globals.js"], a["Core/Series/Point.js"], a["Core/Renderer/RendererUtilities.js"], a["Core/Utilities.js"]],
        function (a, y, I, L, C, z) {
            const {
                animObject: x,
                setAnimation: B
            } = a, {format: u} = y, {marginNames: v} = I, {distribute: l} = C, {
                addEvent: p,
                createElement: t,
                css: m,
                defined: h,
            ...
            class G {
                ...
                colorizeItem(b, a) {
                    ...
                    if (!this.chart.styledMode) {
                        const {itemHiddenStyle: c} = this, g = c.color, k = a ? b.color || g : g,
                ...
                positionCheckboxes() {
                    const b = this.group && this.group.alignAttr, a = this.clipHeight || this.legendHeight,
                        c = this.titleHeight;
                    let d;
                ...
                renderTitle() {
                    var b = this.options;
                    const a = this.padding, c = b.title;
                    let d = 0;
                    c.text && (this.title || (this.title = this.chart.renderer.label(c.text, a - 3, a - 4, void 0, void 0, void 0, b.useHTML, void 0, "legend-title").attr({zIndex: 1}), this.chart.styledMode || this.title.css(c.style), this.title.add(this.group)), c.width || this.title.css({
                        width: this.maxLegendWidth +
                            "px"
                    }), b = this.title.getBBox(), d = b.height, this.offsetWidth = b.width, this.contentGroup.attr({translateY: d}));
                    this.titleHeight = d
                }

                setText(b) {
                    const a = this.options;
                    b.legendItem.label.attr({text: a.labelFormat ? u(a.labelFormat, b, this.chart) : a.labelFormatter.call(b)})
                }

                renderItem(b) {
                    const a = b.legendItem = b.legendItem || {};
                    var c = this.chart, e = c.renderer;
                    const g = this.options, k = this.symbolWidth, h = g.symbolPadding || 0, l = this.itemStyle,
                        m = this.itemHiddenStyle, q = "horizontal" === g.layout ? d(g.itemDistance, 20) : 0, r = !g.rtl,
                        p =
                            !b.series, t = !p && b.series.drawLegendSymbol ? b.series : b;
                    var w = t.options;
                    const v = this.createCheckboxForItem && w && w.showCheckbox, u = g.useHTML, x = b.options.className;
                    let J = a.label;
                    w = k + h + q + (v ? 20 : 0);
                    J || (a.group = e.g("legend-item").addClass("highcharts-" + t.type + "-series highcharts-color-" + b.colorIndex + (x ? " " + x : "") + (p ? " highcharts-series-" + b.index : "")).attr({zIndex: 1}).add(this.scrollGroup), a.label = J = e.text("", r ? k + h : -h, this.baseline || 0, u), c.styledMode || J.css(F(b.visible ? l : m)), J.attr({
                        align: r ? "left" : "right",
                        zIndex: 2
                    }).add(a.group),
                    ...
                    this.colorizeItem(b,
                        b.visible);
                    !c.styledMode && l.width || J.css({width: (g.itemWidth || this.widthOption || c.spacingBox.width) - w + "px"});
                    this.setText(b);
                    c = J.getBBox();
                ...
                layoutItem(b) {
                    var a = this.options;
                    const c = this.padding, e = "horizontal" === a.layout,
                        g = b.itemHeight, k = this.itemMarginBottom, h = this.itemMarginTop,
                        l = e ? d(a.itemDistance, 20) : 0, m = this.maxLegendWidth;
                ...
                adjustMargins(b,
                              a) {
                    const c = this.chart, f = this.options, e = this.getAlignment();
                ...
                proximatePositions() {
                    const b = this.chart, a = [], c = "left" === this.options.align;
                ...
                render() {
                    const b = this.chart, a = b.renderer, c = this.options, d = this.padding;
                    ...
                    h || (this.group = h = a.g("legend").addClass(c.className || "").attr({zIndex: 7}).add(), this.contentGroup = a.g().attr({zIndex: 1}).add(h), this.scrollGroup = a.g().add(this.contentGroup));
                    this.renderTitle();
                    ...
                    g += d;
                    l || (this.box = l = a.rect().addClass("highcharts-legend-box").attr({r: c.borderRadius}).add(h));
                    b.styledMode || l.attr({
                ...
                handleOverflow(b) {
                    const a = this, c = this.chart, e = c.renderer, g = this.options;
                    var k = g.y;
                    const h = "top" === g.verticalAlign, l = this.padding, m = g.maxHeight, q = g.navigation,
                        r = d(q.animation, !0), p = q.arrowSize || 12, t = this.pages,
                        w = this.allItems, v = function (b) {
                            "number" === typeof b ? E.attr({height: b}) : E && (a.clipRect = E.destroy(), a.contentGroup.clip());
                    ...
                    let O = this.nav, E = this.clipRect;
                    ...
                    b && 0 < k && b > k && !1 !== q.enabled ? (this.clipHeight = x = Math.max(k - 20 - this.titleHeight - l, 0), this.currentPage = d(this.currentPage, 1), this.fullHeight = b, w.forEach((b, a) => {
                        ...
                        v(x), O || (this.nav = O = e.g().attr({zIndex: 1}).add(this.group), this.up = e.symbol("triangle", 0, 0, p, p).add(O), u("upTracker").on("click", function () {
                        a.scroll(-1, r)
                        ...
                        a.scroll(1, r)
                    })), a.scroll(0), b = k) : O && (v(), this.nav = O.destroy(), this.scrollGroup.attr({translateY: 1}), this.clipHeight = 0);
                    return b
                }

                scroll(b, a) {
                    const c = this.chart, f = this.pages, e = f.length, g = this.clipHeight,
                        k = this.options.navigation, h = this.pager, l = this.padding;
                    ...
                    0 < m && ("undefined" !== typeof a && B(a, c), this.nav.attr({
                        ...
                        b.attr({"class": 1 === m ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active"})
                    }), h.attr({text: m + "/" + e}), [this.down, this.downTracker].forEach(function (b) {
                        b.attr({
                            x: 18 +
                ...
                setItemEvents(b, a, c) {
                    const d = this, f = b.legendItem || {}, e = d.chart.renderer.boxWrapper, g = b instanceof L,
                        k = "highcharts-legend-" + (g ? "point" : "series") + "-active", h = d.chart.styledMode;
                ...
                createCheckboxForItem(b) {
                    ...
                    p(b.checkbox, "click", function (a) {
                        w(b.series || b, "checkboxClick", {checked: a.target.checked, item: b}, function () {
                            b.select()
                        })
                    })
                }
    ...
    M(a, "Core/Legend/LegendSymbol.js", [a["Core/Utilities.js"]], function (a) {
        ...
        (function (a) {
            a.lineMarker = function (a, B) {
                ...
                var u = this.options;
                const v = a.symbolWidth, l = a.symbolHeight, p = l / 2, t = this.chart.renderer, m = B.group;
                ...
                h["stroke-linecap"] && (e = Math.min(B.line.strokeWidth(),
                    v) / 2);
                v && B.line.attr({d: [["M", e, a], ["L", v - e, a]]});
                g && !1 !== g.enabled && v && (u = Math.min(L(g.radius, p), p), 0 === this.symbol.indexOf("url") && (g = I(g, {
                    width: l,
                    height: l
                }), u = 0), B.symbol = B = t.symbol(this.symbol, v / 2 - u, a - u, 2 * u, 2 * u, x({context: "legend"}, g)).addClass("highcharts-point").add(m), B.isMarker = !0)
            };
            a.rectangle = function (a, x) {
                x = x.legendItem || {};
                const u = a.symbolHeight, v = a.options.squareSymbol;
    ...
    M(a, "Core/Series/SeriesRegistry.js", [a["Core/Globals.js"], a["Core/Defaults.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function (a, y, I, L) {
        ...
        (function (u) {
            ...
            u.seriesType = function (a, p, t, m, h) {
                ...
                p = p || "";
                g[a] = H(g[p], t);
                v(a, z(u.seriesTypes[p] || function () {
                }, m));
    ...
    M(a, "Core/Series/Series.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Defaults.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Legend/LegendSymbol.js"], a["Core/Series/Point.js"], a["Core/Series/SeriesDefaults.js"],
        ...
        const {
            animObject: l,
            setAnimation: p
        } = a, {defaultOptions: t} = y, {registerEventOptions: m} = I, {
            hasTouch: h,
            svg: g,
            win: e
        } = L, {seriesTypes: w} = B, {
        ...
        class aa {
            ...
            bindAxes() {
                const a = this, c = a.options, d = a.chart;
                let f;
            ...
            autoIncrement(b) {
                var a = this.options;
                const c = a.pointIntervalUnit, d = a.relativeXValue, f = this.chart.time;
            ...
            setOptions(b) {
                var a, c;
                const d = this.chart;
                var f = d.options.plotOptions, e = d.userOptions || {};
                const g = V(b);
                b = d.styledMode;
                ...
                e = e.plotOptions || {};
                const l = e.series || {}, m = t.plotOptions[this.type] || {}, q = e[this.type] || {};
                ...
                c.length && r(c[c.length - 1].value) && c.push(b ? {} : {color: this.color, fillColor: this.fillColor});
            ...
            getCyclic(b, a, c) {
                const d = this.chart, f = `${b}Index`, e = `${b}Counter`,
            ...
            findPointIndex(b, a) {
                const d = b.id, f = b.x, e = this.points;
                var g = this.options.dataSorting, k;
                let h, n;
                if (d) g = this.chart.get(d), g instanceof z && (k = g); else if (this.linkedParent || this.enabledDataSorting || this.options.relativeXValue) if (k = a => !a.touched && a.index === b.index, g && g.matchByName ? k = a => !a.touched && a.name === b.name :
            ...
            updateData(b, a) {
                const c = this.options, d = c.dataSorting, f = this.points, e = [], g = this.requireSorting,
                    k = b.length === f.length;
                let n, h, l, m = !0;
                this.xIncrement = null;
                b.forEach(function (b,
                                    a) {
                    var h = r(b) && this.pointClass.prototype.optionsToObject.call({series: this}, b) || {};
                    const m = h.x;
                    if (h.id || T(m)) {
            ...
            setData(a, c = !0, d, f) {
                var e;
                const g = this, k = g.points, h = k && k.length || 0, n = g.options, l = g.chart, m = n.dataSorting,
                    q = g.xAxis, p = n.turboThreshold, r = this.xData, t = this.yData;
            ...
            sortData(b) {
                const a = this, c = a.options.dataSorting.sortKey || "y", d = function (b, a) {
                    return r(a) && b.pointClass.prototype.optionsToObject.call({series: b}, a) || {}
                };
            ...
            getProcessedData(a) {
                const c = this;
                var d = c.xAxis, f = c.options;
                const e = f.cropThreshold, g = a || c.getExtremesFromAll || f.getExtremesFromAll,
                    k = null === d || void 0 === d ? void 0 : d.logarithmic, h = c.isCartesian;
                let n = 0;
                let l;
                a = c.xData;
                f = c.yData;
                ...
                return {xData: a, yData: f, cropped: p, cropStart: n, closestPointRange: d}
            }
            ...
            generatePoints() {
                var b = this.options;
                const a = this.processedData || b.data, c = this.processedXData, d = this.processedYData,
                    e = this.pointClass, g = c.length, k = this.cropStart || 0, h = this.hasGroupedData, l = b.keys,
                    m = [];
            ...
            getExtremes(b, a) {
                const c = this.xAxis;
                var d = this.yAxis;
                const f = this.processedXData || this.xData, e = [], g = this.requireSorting ? this.cropShoulder :
                    0;
            ...
            translate() {
                ...
                this.generatePoints();
                var a = this.options;
                const c = a.stacking, f = this.xAxis, e = f.categories, g = this.enabledDataSorting, h = this.yAxis,
                    l = this.points, m = l.length, q = this.pointPlacementToXValue(), p = !!q, t = a.threshold;
                a = a.startFromThreshold ? t : 0;
                let w, v, u, x,
                    D = Number.MAX_VALUE;
                for (w = 0; w < m; w++) {
                    const n = l[w], m = n.x;
                    let J, Q, R = n.y, O = n.low;
            ...
            getValidPoints(b, a, c) {
                ...
                return (b || this.points || []).filter(function (b) {
                    ...
                    return !c && (b.isNull || !T(e)) || a && !d.isInsidePlot(f, e, {inverted: d.inverted}) ? !1 : !1 !== b.visible
                })
            }
            ...
            setClip() {
                const {chart: b, group: a, markerGroup: c} = this, d = b.sharedClips, f = b.renderer,
                    e = this.getClipBox(), g = this.getSharedClipKey();
                let k = d[g];
            ...
            animate(b) {
                const {chart: a, group: c, markerGroup: d} = this, f = a.inverted;
                var e = l(this.options.animation),
                    g = [this.getSharedClipKey(), e.duration, e.easing, e.defer].join();
                let k = a.sharedClips[g], n = a.sharedClips[g + "m"];
            ...
            drawPoints(b = this.points) {
                const a = this.chart, c = a.styledMode, {colorAxis: d, options: f} = this, e = f.marker,
                ...
                if (!1 !== e.enabled || this._hasPointMarkers) for (h = 0; h < b.length; h++) {
                    ...
                    if ((n && "undefined" === typeof t.enabled || t.enabled) && !l.isNull && !1 !== l.visible) {
                        ...
                        const f =
                            !1 !== l.isInside;
                        !m && f && (0 < (r.width || 0) || l.hasImage) && (l.graphic = m = a.renderer.symbol(b, r.x, r.y, r.width, r.height, p ? t : e).add(g), this.enabledDataSorting && a.hasRendered && (m.attr({x: l.startXPos}), q = "animate"));
                        m && "animate" === q && m[f ? "show" : "hide"](f).animate(r);
                        if (m) if (t = this.pointAttribs(l, c || !l.selected ? void 0 : "select"), c) d && m.css({fill: t.fill}); else m[q](t);
            ...
            pointAttribs(b, a) {
                var c = this.options.marker, d = b && b.options;
                const f = d && d.marker || {};
                var e = d && d.color, g = b && b.color;
            ...
            destroy(b) {
                const a = this, c = a.chart, d = /AppleWebKit\/533/.test(e.navigator.userAgent), f = a.data || [];
                let g, k, h, l;
            ...
            applyZones() {
                const b =
                        this, a = this.chart, c = a.renderer, f = this.zones, e = this.clips || [], g = this.graph,
                    k = this.area, n = Math.max(a.plotWidth, a.plotHeight), h = this[(this.zoneAxis || "y") + "Axis"],
                    l = a.inverted;
            ...
            render() {
                const b = this;
                var a = b.chart;
                const c = b.options, d = l(c.animation), f = b.visible ? "inherit" : "hidden", e = c.zIndex,
                    g = b.hasRendered;
                a = a.seriesGroup;
            ...
            searchPoint(b, a) {
                const c = this.xAxis, d = this.yAxis, f = this.chart.inverted;
            ...
            buildKDTree(b) {
                ...
                const c = this, d = -1 < c.options.findNearestPointBy.indexOf("y") ? 2 : 1;
                delete c.kdTree;
                ba(function () {
            ...
            searchKDTree(b, a, c) {
                ...
                const f = this, e = this.kdAxisArray[0], g = this.kdAxisArray[1], k = a ? "distX" : "dist";
            ...
            pointPlacementToXValue() {
                const {options: {pointPlacement: b, pointRange: a}, xAxis: c} = this;
                let d = b;
            ...
            drawTracker() {
                const b = this, a = b.options, c = a.trackByArea, d = [].concat(c ? b.areaPath : b.graphPath),
                    f = b.chart, e = f.pointer, k = f.renderer,
                    l = f.options.tooltip.snap, m = b.tracker, q = function (c) {
                        if (a.enableMouseTracking && f.hoverSeries !== b) b.onMouseOver()
                    }, p = "rgba(192,192,192," + (g ? .0001 : .002) + ")";
                m ? m.attr({d}) : b.graph && (b.tracker = k.path(d).attr({
                    ...
                    b.dataLabelsGroup].forEach(function (b) {
                    if (b && (b.addClass("highcharts-tracker").on("mouseover", q).on("mouseout", function (b) {
                        e.onTrackerMouseOut(b)
                    }), a.cursor && !f.styledMode && b.css({cursor: a.cursor}), h)) b.on("touchstart", q)
                }));
                n(this, "afterDrawTracker")
            }

            addPoint(b, a, c, d, f) {
                const e = this.options, g = this.data, k = this.chart;
                var h = this.xAxis;
                h = h && h.hasNames && h.names;
                const l = e.data, m = this.xData;
                let q, p;
                a = A(a, !0);
                const r = {series: this};
            ...
            removePoint(b, a, c) {
                const d =
                    this, f = d.data, e = f[b], g = d.points, k = d.chart, h = function () {
            ...
            hasOptionChanged(b) {
                const a = this.options[b], c = this.chart.options.plotOptions, d = this.userOptions[b];
                return d ? a !== d : a !==
            ...
            onMouseOut() {
                const b = this.options, a = this.chart, c = a.tooltip, d = a.hoverPoint;
                a.hoverSeries = null;
                if (d) d.onMouseOut();
            ...
            setState(b, a) {
                const c = this;
                var d = c.options;
                const f = c.graph, e = d.inactiveOtherPoints, g = d.states,
                    k = A(g[b || "normal"] && g[b || "normal"].animation, c.chart.options.chart.animation);
                let h = d.lineWidth, n = 0, l = d.opacity;
                b = b || "";
                if (c.state !== b && ([c.group, c.markerGroup, c.dataLabelsGroup].forEach(function (a) {
                    ...
                    b && (h = g[b].lineWidth || h + (g[b].lineWidthPlus ||
                        0), l = A(g[b].opacity, l));
                    if (f && !f.dashstyle && T(h)) for (d = {"stroke-width": h}, f.animate(d, k); c["zone-graph-" + n];) c["zone-graph-" + n].animate(d, k), n += 1;
            ...
            setVisible(b, a) {
                const c = this, d = c.chart, f = d.options.chart.ignoreHiddenSeries, e = c.visible,
    ...
    M(a, "Core/Chart/Chart.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/Defaults.js"], a["Core/Templating.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Time.js"],
        ...
        const {animate: m, animObject: h, setAnimation: g} = a, {
            defaultOptions: e,
            defaultTime: w
        } = I, {numberFormat: x} = L, {registerEventOptions: F} = C, {
            charts: d,
            doc: k,
            marginNames: r,
            svg: q,
        ...
        class ea {
            ...
            setZoomOptions() {
                const b = this.options.chart, a = b.zooming;
            ...
            orderItems(b, a = 0) {
                const c = this[b], d = this.options[b] = fa(this.options[b]).slice();
            ...
            isInsidePlot(b, a, c = {}) {
                const {
                    inverted: d, plotBox: f,
                    plotLeft: e, plotTop: g, scrollablePlotBox: k
                } = this;
                var h = 0;
                let n = 0;
                ...
                const l = c.series, m = c.visiblePlotOnly && k || f;
                var q = c.inverted ? a : b;
                a = c.inverted ? b : a;
                b = {x: q, y: a, isInsidePlot: !0, options: c};
                if (!c.ignoreX) {
                    const a = l && (d && !this.polar ? l.yAxis : l.xAxis) || {pos: e, len: Infinity};
            ...
            redraw(b) {
                A(this, "beforeRedraw");
                const a = this.hasCartesianSeries ? this.axes : this.colorAxis || [], c = this.series, d = this.pointer,
                    f = this.legend, e = this.userOptions.legend, k = this.renderer, h = k.isHidden(), n = [];
                let l, m, q = this.isDirtyBox, p = this.isDirtyLegend, r;
            ...
            applyDescription(b, a) {
                const c = this, d = this.options[b] = N(this.options[b], a);
                let f = this[b];
                ...
                d && !f && (f = this.renderer.text(d.text, 0, 0, d.useHTML).attr({
                    ...
                    c.layOutTitles(d)
                }, this.styledMode || f.css(V("title" === b ? {fontSize: this.options.isStock ? "1em" : "1.2em"} : {}, d.style)), this[b] = f)
            }

            layOutTitles(b = !0) {
                const a = [0, 0, 0], c = this.renderer, d = this.spacingBox;
                ["title", "subtitle", "caption"].forEach(function (b) {
                    const f = this[b], e = this.options[b], g = e.verticalAlign || "top";
                    ...
                    if (f) {
                        ...
                        const k = c.fontMetrics(f).b, h = Math.round(f.getBBox(e.useHTML).height);
                        f.align(V({y: "bottom" === g ? k : b + k, height: h}, e), !1, "spacingBox");
            ...
            getContainerBox() {
                return {width: M(this.renderTo, "width", !0) || 0, height: M(this.renderTo, "height", !0) || 0}
            }
            ...
            getChartSize() {
                ...
                this.chartHeight = Math.max(0, ha(b, this.chartWidth) || (1 < c.height ? c.height : 200));
                this.containerBox = c
            }
            ...
            getAxisMargins() {
                const b = this, a = b.axisOffset = [0, 0, 0, 0], c = b.colorAxis, d = b.margin, f = function (b) {
                    b.forEach(function (b) {
            ...
            reflow(b) {
                ...
                const d =
                    a.containerBox, f = a.getContainerBox();
            ...
            setSize(b, a, c) {
                ...
                d.getChartSize();
                d.styledMode || (c ? m : P)(d.container, {width: d.chartWidth + "px", height: d.chartHeight + "px"}, c);
                d.setChartSize(!0);
            ...
            setChartSize(b) {
                ...
                var d = this.chartWidth, f = this.chartHeight;
            ...
            resetMargins() {
                A(this, "resetMargins");
                const b = this, a = b.options.chart;
                ["margin", "spacing"].forEach(function (c) {
                    const d = a[c], f = aa(d) ? d : [d, d, d, d];
            ...
            drawChartBox() {
                const b = this.options.chart,
                    a = this.renderer, c = this.chartWidth, d = this.chartHeight, f = this.styledMode,
                    e = this.plotBGImage;
                var g = b.backgroundColor;
                const k = b.plotBackgroundColor, h = b.plotBackgroundImage, n = this.plotLeft, l = this.plotTop,
                    m = this.plotWidth, q = this.plotHeight, p = this.plotBox, r = this.clipRect, t = this.clipBox;
                let w = this.chartBackground, v = this.plotBackground, u = this.plotBorder, x, D, E = "animate";
                ...
                w[E]({x: D / 2, y: D / 2, width: c - D - x % 2, height: d - D - x % 2, r: b.borderRadius});
                E = "animate";
                v || (E = "attr", this.plotBackground = v = a.rect().addClass("highcharts-plot-background").add());
                v[E](p);
                f || (v.attr({fill: k || "none"}).shadow(b.plotShadow), h && (e ? (h !== e.attr("href") && e.attr("href", h), e.animate(p)) : this.plotBGImage = a.image(h, n, l, m, q).add()));
                r ? r.animate({width: t.width, height: t.height}) :
                    this.clipRect = a.clipRect(t);
                E = "animate";
                u || (E = "attr", this.plotBorder = u = a.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add());
                f || u.attr({stroke: b.plotBorderColor, "stroke-width": b.plotBorderWidth || 0, fill: "none"});
            ...
            propFromSeries() {
                const a = this, c = a.options.chart, d = a.options.series;
                let f, e, g;
            ...
            render() {
                const b = this.axes, a = this.colorAxis, c = this.renderer, d = function (b) {
                    b.forEach(function (b) {
                        b.visible && b.render()
                    })
                };
                ...
                this.getAxisMargins();
                const k = 1.1 <
                    e / this.plotWidth, h = 1.05 < g / this.plotHeight;
            ...
            addCredits(b) {
                const a = this, c = N(!0, this.options.credits, b);
                c.enabled &&
            ...
            destroy() {
                const b = this, a = b.axes, c = b.series, f = b.container, e = f && f.parentNode;
                let g;
                A(b, "destroy");
            ...
            addSeries(b, a, c) {
                const d = this;
                let f;
                b && (a = S(a, !0), A(d, "addSeries", {options: b}, function () {
                    f = d.initSeries(b);
                    d.isDirtyLegend = !0;
                    d.linkSeries();
            ...
            showLoading(b) {
                const a = this, c = a.options, d = c.loading, e = function () {
                    g && P(g, {
                        left: a.plotLeft + "px",
                        top: a.plotTop + "px",
                ...
                let g = a.loadingDiv, k = a.loadingSpan;
                g || (a.loadingDiv = g = n("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, a.container));
                k || (a.loadingSpan = k = n("span", {className: "highcharts-loading-inner"}, null, g), f(a, "redraw", e));
                g.className = "highcharts-loading";
                t.setElementHTML(k, S(b, c.lang.loading, ""));
                a.styledMode || (P(g,
                    V(d.style, {zIndex: 10})), P(k, d.labelStyle), a.loadingShown || (P(g, {
                    opacity: 0,
                    display: ""
                }), m(g, {opacity: d.style.opacity || .5}, {duration: d.showDuration || 0})));
                a.loadingShown = !0;
                e()
            }
            ...
            hideLoading() {
                ...
                a && (a.className = "highcharts-loading highcharts-loading-hidden", this.styledMode || m(a, {opacity: 0}, {
            ...
            showResetZoom() {
                ...
                const a = this, c = e.lang, d = a.zooming.resetButton, f = d.theme,
            ...
            zoom(b) {
                const a = this, c = a.pointer;
                let d = !1, f;
                !b || b.resetSelection ? (a.axes.forEach(function (b) {
                    f = b.zoom()
                }), c.initiated = !1) : b.xAxis.concat(b.yAxis).forEach(function (b) {
                    const e = b.axis;
                    if (c[e.isXAxis ? "zoomX" : "zoomY"] && D(c.mouseDownX) && D(c.mouseDownY) && a.isInsidePlot(c.mouseDownX - a.plotLeft, c.mouseDownY - a.plotTop, {axis: e}) || !D(a.inverted ? c.mouseDownX : c.mouseDownY)) f = e.zoom(b.min, b.max), e.displayBtn && (d = !0)
                });
                ...
                A(this, "pan", {originalEvent: b}, function () {
                    ...
                    a.forEach(function (a) {
                        if (a.options.panningEnabled &&
                            ...
                            var d = a.horiz, k = b[d ? "chartX" : "chartY"];
                            d = d ? "mouseDownX" : "mouseDownY";
                            var h = c[d], n = a.minPointOffset || 0,
                                l = a.reversed && !c.inverted || !a.reversed && c.inverted ? -1 : 1,
                                m = a.getExtremes(), q = a.toValue(h - k, !0) + n * l,
    ...
    M(a, "Extensions/ScrollablePlotArea.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Series/Series.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]],
        function (a, y, I, L, C, z) {
            const {stop: x} = a, {addEvent: B, createElement: u, defined: v, merge: l, pick: p} = z;
                ...
                if (!this.renderer.forExport) {
                    ...
                    g && !a.skipAxes && this.axes.forEach(function (a) {
                        g[a.side] ? a.getPlotLinePath = function () {
                            let e = g[a.side].name, h = this[e], l;
            ...
            I.prototype.setUpScrolling = function () {
                ...
                this.scrollingContainer =
                    u("div", {className: "highcharts-scrolling"}, a, this.scrollingParent);
                let l;
            ...
            I.prototype.applyFixed = function () {
                var a = !this.fixedDiv, l = this.options.chart, h = l.scrollablePlotArea, g = C.getRendererType();
                a ? (this.fixedDiv =
                    u("div", {className: "highcharts-fixed"}, {
                        position: "absolute",
                        overflow: "hidden",
                        pointerEvents: "none",
                ...
                this.renderer.boxWrapper.attr({width: l, height: g, viewBox: [0, 0, l, g].join(" ")});
                ...
                a = this.scrollablePixelsX ? [["M", 0, a], ["L", this.plotLeft - 1, a], ["L", this.plotLeft - 1, l], ["L", 0, l], ["Z"], ["M", e, a], ["L", this.chartWidth, a], ["L", this.chartWidth, l], ["L", e, l], ["Z"]] : this.scrollablePixelsY ? [["M", h, 0], ["L", h, this.plotTop - 1], ["L", g, this.plotTop - 1], ["L", g, 0], ["Z"], ["M", h, w], ["L", h, this.chartHeight], ["L", g, this.chartHeight], ["L",
                    g, w], ["Z"]] : [["M", 0, 0]];
    ...
    M(a, "Core/Axis/Stacking/StackItem.js", [a["Core/Templating.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, y, I) {
        const {format: x} = a, {series: C} = y, {destroyObjectProperties: z, fireEvent: H, isNumber: B, pick: u} = I;
        ...
        class v {
            ...
            setOffset(a, p, t, m, h, g) {
                const {
                    alignOptions: e,
                    axis: l, label: v, options: x, textAlign: d
                } = this, k = l.chart;
                t = this.getStackBox({xOffset: a, width: p, boxBottom: t, boxTop: m, defaultX: h, xAxis: g});
                ...
                if (v && t) {
                    ...
                    e.x = x.x || 0;
                    e.y = x.y || 0;
                    const {x: a, y: p} = this.adjustStackPosition({labelBox: m, verticalAlign: r, textAlign: d});
                    t.x -= a;
                    t.y -= p;
                    v.align(e, !1, t);
            ...
            adjustStackPosition({labelBox: a, verticalAlign: p, textAlign: t}) {
                ...
                return {x: a.width / 2 + a.width / 2 * l[t], y: a.height / 2 * l[p]}
            }

            getStackBox(a) {
                var l = this.axis;
                const t = l.chart, {
                    boxTop: m, defaultX: h, xOffset: g,
                    width: e, boxBottom: w
                } = a;
                ...
                return t.inverted ? {
                    ...
                    width: l,
                    height: e
                } : {x: x + a.transB - t.plotLeft, y: (d ? v - l : v) - t.plotTop, width: e, height: l}
            }
        }
    ...
    M(a, "Core/Axis/Stacking/StackingAxis.js", [a["Core/Animation/AnimationUtilities.js"],
        ...
        function u(b, a, d, e) {
            !w(b) || b.x !== a || e && b.stackKey !== e ? b = {x: a, index: 0, key: e, stackKey: e} : b.index++;
            b.key = [d, a, b.index].join();
            return b
        }

        function v() {
            const b = this, a = b.stackKey, d = b.yAxis.stacking.stacks, e = b.processedXData,
        ...
        function t(b) {
            ...
            if (f && (!0 === this.visible || !1 === a.options.chart.ignoreHiddenSeries)) {
                var g = this.processedXData, k = this.processedYData, h = [], l = k.length, m = this.options,
                    p = m.threshold, r = q(m.startFromThreshold && p, 0);
                m = m.stack;
                b = b ? `${this.type},${f}` : this.stackKey;
                var t = "-" + b, v = this.negStacks;
                a = "group" === f ? a.yAxis[0] : this.yAxis;
                var u = a.stacking.stacks, x = a.stacking.oldStacks, E, G;
        ...
        class G {
            ...
            buildStacks() {
                const b = this.axis, a = b.series, d = b.options.reversedStacks, e = a.length;
                let g, k;
            ...
            renderStackTotals() {
                var b = this.axis;
                const a = b.chart, d = a.renderer, e = this.stacks;
    ...
    M(a, "Series/Line/LineSeries.js", [a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]],
        function (a, y, I) {
            ...
            class z extends a {
                ...
                drawGraph() {
                    const a = this, x = this.options, u = (this.gappedPath || this.getGraphPath).call(this),
                    ...
                    l.forEach(function (l, t) {
                        ...
                        h ? (h.endX = a.preventGraphAnimation ? null : u.xMap, h.animate({d: u})) :
                            u.length && (a[m] = h = a.chart.renderer.path(u).addClass(l[1]).attr({zIndex: 1}).add(a.group));
                        h && !v && (m = {
                            stroke: l[2],
                ...
                getGraphPath(a, B, u) {
                    ...
                    const g = a.reversed;
                    g && a.reverse();
                    (h = {right: 1, center: 2}[h] || h && 3) && g && (h =
                        4 - h);
                    a = this.getValidPoints(a, !1, !(l.connectNulls && !B && !u));
                    a.forEach(function (e, g) {
                        const w = e.plotX, F = e.plotY, d = a[g - 1], k = e.isNull || "number" !== typeof F;
                        (e.leftCliff || d && d.rightCliff) && !u && (m = !0);
                        k && !x(B) && 0 < g ? m = !l.connectNulls : k && !B ? m = !0 : (0 === g || m ? g = [["M", e.plotX, e.plotY]] : v.getPointSpline ? g = [v.getPointSpline(a, e, g)] : h ? (g = 1 === h ? [["L", d.plotX, F]] : 2 === h ? [["L", (d.plotX + w) / 2, d.plotY], ["L", (d.plotX + w) / 2, F]] : [["L", w, d.plotY]], g.push(["L", w, F])) : g = [["L", w, F]], t.push(e.x), h && (t.push(e.x), 2 === h && t.push(e.x)),
    ...
    M(a, "Series/Area/AreaSeries.js", [a["Core/Color/Color.js"], a["Core/Series/SeriesRegistry.js"],
        ...
        class u extends x {
            ...
            drawGraph() {
                ...
                const a = this, l = this.areaPath, p = this.options,
                ...
                t.forEach(function (m) {
                    ...
                    e ? (e.endX = a.preventGraphAnimation ? null : l.xMap, e.animate({d: l})) : (g.zIndex = 0, e = a[h] = a.chart.renderer.path(l).addClass(m[1]).add(a.group), e.isArea = !0);
            ...
            getGraphPath(a) {
                ...
                const t = p.stacking, m = this.yAxis, h = [], g = [], e = this.index,
                    w = m.stacking.stacks[this.stackKey], v = p.threshold, u = Math.round(m.getThreshold(p.threshold));
                ...
                var d = function (d, b, f) {
                    ...
                    "undefined" !== typeof l && (g.push({
                        ...
                        isNull: c,
                        isCliff: !0
                    }), h.push({plotX: k, plotY: null === q ? u : m.getThreshold(q), doCurve: !1}))
                };
                let k;
                a = a || this.points;
            ...
            getStackPoints(a) {
                const l =
                        this, p = [], t = [], m = this.xAxis, h = this.yAxis, g = h.stacking.stacks[this.stackKey], e = {},
                    w = h.series, v = w.length, u = h.options.reversedStacks ? 1 : -1, d = w.indexOf(l);
                a = a || this.points;
                if (this.options.stacking) {
                    ...
                    t.forEach(function (a, q) {
                        ...
                        if (e[a] && !e[a].isNull) p.push(e[a]), [-1, 1].forEach(function (c) {
                            ...
                            p.push({isNull: !0, plotX: m.translate(a, 0, 0, 0, 1), x: a, plotY: r, yBottom: r})
                        }
                    })
                }
                return p
    ...
    M(a, "Series/Spline/SplineSeries.js", [a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, y) {
        const {line: x} = a.seriesTypes, {merge: L, pick: C} = y;
        ...
        class z extends x {
            ...
            getPointSpline(a, x, u) {
                const v = x.plotX || 0, l = x.plotY || 0, p = a[u - 1];
                u = a[u + 1];
                let t, m;
                let h;
    ...
    M(a, "Series/Column/ColumnSeries.js", [a["Core/Animation/AnimationUtilities.js"],
        ...
        const {animObject: x} = a, {parse: u} = y, {hasTouch: v, noop: l} = L, {
            clamp: p,
            defined: t,
            extend: m,
            fireEvent: h,
        ...
        class d extends C {
            ...
            animate(a) {
                const d = this, e = this.yAxis,
                    g = e.pos, b = d.options, f = this.chart.inverted, c = {}, k = f ? "translateX" : "translateY";
                let h;
                a ? (c.scaleY = .001, a = p(e.toPixels(b.threshold), g, g + e.len), f ? c.translateX = a - e.len : c.translateY = a, d.clipBox && d.setClip(), d.group.attr(c)) : (h = Number(d.group.attr(k)), d.group.animate({scaleY: 1}, m(x(d.options.animation), {
                    step: function (b, a) {
            ...
            getColumnMetrics() {
                ...
                const l =
                    ...
                    m = l * d.groupPadding, p = (l - 2 * m) / (h || 1);
            ...
            translate() {
                const a = this, d = a.chart, g = a.options;
                var l = a.dense = 2 > a.closestPointRange * a.xAxis.transA;
                l = a.borderWidth = E(g.borderWidth, l ? 0 : 1);
                const b = a.xAxis, f = a.yAxis, c = g.threshold, n = E(g.minPointLength, 5), m = a.getColumnMetrics(),
                    w = m.width, v = a.pointXOffset = m.offset, u = a.dataMin, x = a.dataMax;
                let F = a.barW = Math.max(w, 1 + 2 * l), y = a.translatedThreshold =
                    f.getThreshold(c);
                d.inverted && (y -= .5);
                ...
                a.points.forEach(function (k) {
                    ...
                    var l = 999 + Math.abs(h), q = k.plotX || 0;
                    l = p(k.plotY, -l, f.len + l);
                    let r = Math.min(l, h), D = Math.max(l, h) - r, z = w, B = q + v, G = F;
            ...
            pointAttribs(a, d) {
                ...
                var g = this.pointAttrToOptions || {}, b = g.stroke || "borderColor";
                const f = g["stroke-width"] || "borderWidth";
                let c, k = a && a.color || this.color, h = a && a[b] || e[b] || k;
                g = a && a.options.dashStyle || e.dashStyle;
                let l = a && a[f] || e[f] || this[f] || 0, m = E(a && a.opacity, e.opacity, 1);
            ...
            drawPoints(a = this.points) {
                const d = this, g = this.chart, k = d.options, b = g.renderer, f = k.animationLimit || 250;
                let c;
                a.forEach(function (a) {
                    let h = a.graphic, l = !!h, n = h && g.pointCount < f ? "animate" : "attr";
                    if (e(a.plotY) && null !== a.y) {
                        c = a.shapeArgs;
                        h && a.hasNewShapeType() &&
                        (h = h.destroy());
                        d.enabledDataSorting && (a.startXPos = d.xAxis.reversed ? -(c ? c.width || 0 : 0) : d.xAxis.width);
                        h || (a.graphic = h = b[a.shapeType](c).add(a.group || d.group)) && d.enabledDataSorting && g.hasRendered && g.pointCount < f && (h.attr({x: a.startXPos}), l = !0, n = "animate");
                        if (h && l) h[n](w(c));
            ...
            drawTracker(a =
                            this.points) {
                const d = this, e = d.chart, k = e.pointer, b = function (a) {
                ...
                d._hasTracking || (d.trackerGroups.forEach(function (a) {
                    if (d[a]) {
                        ...
                        !e.styledMode && d.options.cursor && d[a].css({cursor: d.options.cursor})
                    }
                }), d._hasTracking = !0);
    ...
    M(a, "Core/Series/DataLabel.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Templating.js"], a["Core/Utilities.js"]], function (a, y, I) {
        const {getDeferredAnimation: x} = a, {format: C} = y, {
            defined: z,
            extend: H,
            fireEvent: B,
            isArray: u,
        ...
        (function (a) {
            function e(a, d, c, e, g) {
                ...
                var h = a.plotX, l = a.plotY;
                const n = c.rotation;
                var m = c.align;
                l = z(h) && z(l) && b.isInsidePlot(h,
                    Math.round(l), {inverted: f, paneCoordinates: !0, series: this});
                ...
                if (f && h) {
                    ...
                    n ? (p = !1,
                        ...
                        y: e.y + (c.y || 0) + {top: 0, middle: .5, bottom: 1}[c.verticalAlign] * e.height
            ...
            function F(a) {
                ...
                !b && c && (this.visible && c.show(), this.options.animation ? c.animate({opacity: 1}, a) : c.attr({opacity: 1}));
                return c
            }

            function d(a = this.points) {
                var b, c;
                const d = this, e = d.chart, k = d.options, h = e.renderer, {
                    backgroundColor: l,
                    plotBackgroundColor: q
                } = e.options.chart, w = e.options.plotOptions, E = h.getContrast(v(q) && q || v(l) && l || "#000000");
                let F = k.dataLabels, A, y;
                var G = m(F)[0];
                const H = G.animation;
                ...
                if (u(F) || F.enabled || d._hasPointLabels) y = this.initDataLabels(G), a.forEach(a => {
                    ...
                    A.forEach((b, f) => {
                        ...
                        if (m) {
                            ...
                            r =
                                {r: b.borderRadius || 0, rotation: A, padding: b.padding, zIndex: 1};
                            if (!e.styledMode) {
            ...
            function k(a, d, c, e, g, k) {
                const b = this.chart, f = d.align, h = d.verticalAlign, l = a.box ? 0 : a.padding || 0;
                let {x: m = 0, y: n = 0} = d, p, q;
                p = (c.x || 0) + l;
            ...
            function r(a, d) {
                ...
                if (u(a) && !u(d)) b = a.map(function (a) {
                    ...
                    !u(d)) b = l(a, d); else if (u(a) && u(d)) for (f = Math.max(a.length, d.length); f--;) b[f] = l(a[f], d[f]);
                return b
            }

            function q(a, d, c, e, g) {
                const b = this.chart, f = b.inverted, k = this.xAxis, h = k.reversed,
                    l = f ? d.height / 2 : d.width / 2;
                a = (a = a.pointWidth) ? a / 2 : 0;
                d.startXPos = f ? g.x : h ? -l - a : k.width - l + a;
                d.startYPos = f ? h ? this.yAxis.height - l + a : -l - a : g.y;
                e ? "hidden" === d.visibility && (d.show(), d.attr({opacity: 0}).animate({opacity: 1})) : d.attr({opacity: 1}).animate({opacity: 0}, void 0, d.hide);
                b.hasRendered && (c && d.attr({x: d.startXPos, y: d.startYPos}),
                    d.placed = !0)
            }
    ...
    M(a, "Series/Column/ColumnDataLabel.js", [a["Core/Series/DataLabel.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, y, I) {
        ...
        (function (y) {
            function u(a, p, t, m, h) {
                ...
                let u = z(a.below, a.plotY > z(this.translatedThreshold, e)), d = z(t.inside, !!this.options.stacking);
    ...
    M(a, "Series/Scatter/ScatterSeries.js",
        [a["Series/Scatter/ScatterSeriesDefaults.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, y, I) {
            ...
            class u extends C {
                ...
                applyJitter() {
                    const a = this, l = this.options.jitter, p = this.points.length;
    ...
    M(a, "Series/CenteredUtilities.js", [a["Core/Globals.js"], a["Core/Series/Series.js"], a["Core/Utilities.js"]], function (a, y, I) {
        const {deg2rad: x} = a, {fireEvent: C, isNumber: z, pick: H, relativeLength: B} = I;
        var u;
        (function (a) {
            a.getCenter = function () {
                var a = this.options, p = this.chart;
                const t = 2 * (a.slicedOffset || 0), m = p.plotWidth - 2 * t, h = p.plotHeight - 2 * t;
                var g = a.center;
                const e = Math.min(m, h), w = a.thickness;
                var v = a.size;
                let u = a.innerSize || 0;
    ...
    M(a, "Series/Pie/PiePoint.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function (a, y, I) {
        const {setAnimation: x} = a, {addEvent: C, defined: z, extend: H, isNumber: B, pick: u, relativeLength: v} = I;
        ...
        class l extends y {
            ...
            getConnectorPath() {
                const a = this.labelPosition, l = this.series.options.dataLabels, m = this.connectorShapes;
    ...
    M(a, "Series/Pie/PieSeries.js", [a["Series/CenteredUtilities.js"], a["Series/Column/ColumnSeries.js"], a["Core/Globals.js"], a["Series/Pie/PiePoint.js"], a["Series/Pie/PieSeriesDefaults.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Renderer/SVG/Symbols.js"], a["Core/Utilities.js"]], function (a, y, I, L, C, z, H, B, u) {
        ...
        class e extends z {
            ...
            animate(a) {
                const e = this, g = e.points, d = e.startAngleRad;
                a || g.forEach(function (a) {
                    const g = a.graphic, k = a.shapeArgs;
                    g && k && (g.attr({
                        r: h(a.startR, e.center && e.center[3] / 2),
                        start: d,
                        end: d
                    }), g.animate({r: k.r, start: k.start, end: k.end}, e.options.animation))
                })
            }

            drawEmpty() {
                const a = this.startAngleRad, e = this.endAngleRad, g = this.options;
                let d, k;
            ...
            getX(a, e, g) {
                const d = this.center, k = this.radii ? this.radii[g.index] || 0 : d[2] / 2;
            ...
            translate(a) {
                ...
                for (c = 0; c < b; c++) {
                    ...
                    n.labelPosition = {
                        ...
                        connectorPosition: {
                            breakAt: {x: a[0] + y + Math.cos(x) * u, y: a[1] + f + Math.sin(x) * u},
    ...
    M(a, "Series/Pie/PieDataLabel.js", [a["Core/Series/DataLabel.js"], a["Core/Globals.js"], a["Core/Renderer/RendererUtilities.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Utilities.js"]], function (a, y, I, L, C) {
        const {noop: x} = y, {distribute: H} = I, {series: B} = L, {
            arrayMax: u,
            clamp: v,
            defined: l,
            merge: p,
        ...
        (function (g) {
            function e() {
                const a = this, d = a.data, e = a.chart, g = a.options.dataLabels || {}, b = g.connectorPadding,
                    f = e.plotWidth, c = e.plotHeight, h = e.plotLeft, m = Math.round(e.chartWidth /
                        3), w = a.center, v = w[2] / 2, x = w[1], y = [[], []], z = [0, 0, 0, 0],
                ...
                a.visible && (g.enabled || a._hasPointLabels) && (d.forEach(function (a) {
                    ...
                    if (m) {
                        ...
                        for (W = 0; W < m; W++) {
                            ...
                            I._pos = {
                                x: N + t(U.x, g.x) + ({left: b, right: -b}[M.alignment] || 0),
                ...
                this.points.forEach(function (a) {
                    ...
                    d && a.visible && ((e = d._pos) ? (d.sideOverflow && (d._attr.width = Math.max(d.getBBox().width - d.sideOverflow, 0), d.css({
                        width: d._attr.width + "px", textOverflow: (this.options.dataLabels.style ||
                            {}).textOverflow || "ellipsis"
                    }), d.shortened = !0), d.attr(d._attr), d[d.moved ? "animate" : "attr"](e), d.moved = !0) : d && d.attr({y: -9999}));
                    delete a.distributeBox
                }, this)
            }

            function y(a) {
                let d = this.center, e = this.options, g = e.center, b = e.minSize || 80, f, c = null !== e.size;
    ...
    M(a, "Extensions/OverlappingDataLabels.js", [a["Core/Chart/Chart.js"], a["Core/Utilities.js"]], function (a, y) {
        function x(a, l) {
            ...
            }), C(l, "afterHideOverlappingLabel")) : a.attr({opacity: p})), a.isOld = !0);
            return t
        }
        ...
        a.prototype.hideOverlappingLabels = function (a) {
            let l = this, p = a.length, t = l.renderer;
            var m;
            let h;
            let g, e, w, u = !1;
            var v = function (a) {
                let d, e;
                var g;
                let h = a.box ? 0 : a.padding || 0, b = g = 0, f, c;
            ...
            for (h = 0; h < p; h++) for (e = (v = a[h]) && v.absoluteBox, m = h + 1; m < p; ++m) w = (g = a[m]) && g.absoluteBox, !e || !w || v === g || 0 === v.newOpacity || 0 === g.newOpacity || "hidden" === v.visibility || "hidden" === g.visibility || w.x >= e.x + e.width || w.x + w.width <= e.x || w.y >= e.y + e.height || w.y + w.height <= e.y ||
        ...
        if (-1 === L.symbolCustomAttribs.indexOf("borderRadius")) {
            ...
            C.prototype.symbols.arc = function (a, g, l, m, d = {}) {
                ...
                for (g = a.length - 1; g--;) {
                    {
                        let e =
                            void 0, h = void 0, k = void 0;
                        m = a;
                        var b = g, f = 1 < g ? l : d, c = m[b], n = m[b + 1];
                        "Z" === n[0] && (n = m[0]);
            ...
            C.prototype.symbols.roundedRect = function (a, h, l, m, d = {}) {
                const e = g(a, h, l, m, d), {r: p = 0, brBoxHeight: q = m, brBoxY: t = h} = d;
                var b = h - t, f = t + q - (h + m);
                d = -.1 < b - p ? 0 : p;
                const c = -.1 < f - p ? 0 : p;
                ...
                f = [a + d, h];
                b = [a + l - d, h];
                const w = [a + l, h + d], v = [a + l, h + m - c], x = [a + l - c, h + m], y = [a + c, h + m],
                    z = [a, h + m - c], B = [a, h + d];
                if (n) {
                    const a =
                ...
                e.length = 0;
                e.push(["M", ...f], ["L", ...b], ["A",
                    d, d, 0, 0, 1, ...w], ["L", ...v], ["A", c, c, 0, 0, 1, ...x], ["L", ...y], ["A", c, c, 0, 0, 1, ...z], ["L", ...B], ["A", d, d, 0, 0, 1, ...f], ["Z"]);
                return e
            };
            ...
            B(y, "afterColumnTranslate", function () {
                ...
                if (this.options.borderRadius && (!this.chart.is3d || !this.chart.is3d())) {
                    ...
                    for (const k of this.points) if ({shapeArgs: h} = k, "roundedRect" === k.shapeType && h) {
    ...
    M(a, "Core/Responsive.js", [a["Core/Utilities.js"]], function (a) {
        const {diffObjects: x, extend: I, find: L, merge: C, pick: z, uniqueKey: H} = a;
        var B;
        (function (u) {
            function v(a, l) {
                const h = a.condition;
            ...
            u.compose = function (t) {
                a.pushUnique(p, t) && I(t.prototype, {matchResponsiveRule: v, setResponsive: l});
                return t
            }
        })(B || (B = {}));
        "";
